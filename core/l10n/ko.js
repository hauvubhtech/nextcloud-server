OC.L10N.register(
    ...
    "This community release of xD Drive is unsupported and push notifications are limited." : "이 xD Drive 커뮤니티 릴리즈는 지원하지 않는 버전이며, 푸시 알림은 제한됩니다.",
    "Login" : "로그인",
    ...
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications are limited to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at {linkstart}https://nextcloud.com/enterprise{linkend}." : "이 빌드는 공식적으로 지원하지 않는 xD Drive 커뮤니티 빌드입니다. 이 인스턴스의 크기를 고려하면, 성능과 신뢰성, 확장성 등을 보장할 수 없습니다. 무료 서비스의 과부하를 방지하기 위해 푸시 알림은 제한됩니다. xD Drive Enterprise의 혜택에 대해서는 {linkstart}https://nextcloud.com/enterprise{linkend}를 참조하십시오.",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "업데이트가 실패했습니다. 이 문제를 <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive 커뮤니티</a>에 보고하여 주십시오.",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "Nextcloud를 다시 설치하려고 하는 것 같습니다. 그러나 현재 설정 디렉터리에 CAN_INSTALL 파일이 없는 것 같습니다. 계속 진행하려면 설정 폴더에 CAN_INSTALL 폴더를 만드십시오.",
    ...
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "사용자수 제한을 해제하기 위해 구독키를 입력하세요. 기업용 Nextcloud에 대해 자세히 알고 싶다면, 저희 웹사이트를 방문하세요.",
    "[%d / %d]: Checking table %s" : "[%d / %d]: 테이블 %s 확인 중",
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications have been disabled to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at nextcloud.com/enterprise." : "이 빌드는 공식적으로 지원하지 않는 xD Drive 커뮤니티 빌드입니다. 이 인스턴스의 크기를 고려하면, 성능과 신뢰성, 확장성 등을 보장할 수 없습니다. 무료 서비스의 과부하를 방지하기 위해 푸시 알림은 제한됩니다. xD Drive Enterprise의 혜택에 대해서는 https://nextcloud.com/enterprise를 참조하십시오.",
    "xD Drive 23 is the last release supporting PHP 7.3. xD Drive 24 requires at least PHP 7.4." : "xD Drive 23이 PHP 7.3를 지원하는 마지막 릴리즈입니다. xD Drive 24은 PHP 7.4 이상이 필요합니다.",
