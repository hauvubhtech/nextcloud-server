OC.L10N.register(
    ...
    "This community release of xD Drive is unsupported and push notifications are limited." : "这个 xD Drive 的社区版本不受支持，推送通知功能受限。",
    "Login" : "登录",
    ...
    "Please make sure to set the \"overwrite.cli.url\" option in your config.php file to the URL that your users mainly use to access this xD Drive. Suggestion: \"{suggestedOverwriteCliURL}\". Otherwise there might be problems with the URL generation via cron. (It is possible though that the suggested URL is not the URL that your users mainly use to access this xD Drive. Best is to double check this in any case.)" : "请确保在您的 config.php 文件中设置 \"overwrite.cli.url\" 选项为您的用户主要用于访问该 xD Drive 的URL。建议：“{suggestedOverwriteCliURL}\"。否则可能会出现通过 cron 生成 URL 的问题。(但建议的 URL 有可能不是您的用户主要用来访问此 xD Drive 的 URL。最好是在任何情况下都仔细检查一下）。",
    ...
    "The database is missing some indexes. Due to the fact that adding indexes on big tables could take some time they were not added automatically. By running \"occ db:add-missing-indices\" those missing indexes could be added manually while the instance keeps running. Once the indexes are added queries to those tables are usually much faster." : "数据库丢失了一些索引。由于给大的数据表添加索引会耗费一些时间，因此程序没有自动对其进行修复。您可以在 xD Drive 运行时通过命令行手动执行 \"occ db:add-missing-indices\" 命令修复丢失的索引。索引修复后会大大提高相应表的查询速度。",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "升级失败。请将此问题报告给 <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive 社区</a>。",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "看起来您正在尝试重新安装您的Nextcloud。但您的config文件夹中没有CAN_INSTALL文件。请在您的config文件夹中创建CAN_INSTALL文件以继续。",
    ...
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "输入订阅密钥以增加用户限制。欲了解更多关于Nextcloud企业版的信息，请访问我们的网站。",
    "[%d / %d]: Checking table %s" : "[%d / %d]：检查数据表 %s",
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications have been disabled to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at nextcloud.com/enterprise." : "这是 xD Drive 不受支持的社区构建。鉴于此实例的大小，无法保证性能、可靠性和可伸缩性。推送通知已被禁用，以避免超量使用我们的免费服务。访问 nextcloud.com/enterprise 了解更多关于企业版的优势。",
    "xD Drive 23 is the last release supporting PHP 7.3. xD Drive 24 requires at least PHP 7.4." : "xD Drive 23 是支持 PHP 7.3 的最后一个版本。xD Drive 24 需要至少 PHP 7.4。",
