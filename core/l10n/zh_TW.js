OC.L10N.register(
    ...
    "This community release of xD Drive is unsupported and push notifications are limited." : "不支援 xD Drive 的這個社群版本，且推播通知有所限制。",
    "Login" : "登入",
    ...
    "Enter your subscription key in the support app in order to increase the user limit. This does also grant you all additional benefits that xD Drive Enterprise offers and is highly recommended for the operation in companies." : "在支援應用程式中輸入您的訂閱金鑰以增加使用者限制。這也確實為您提供了 xD Drive Enterprise 提供的所有額外好處，並且強烈推薦用於公司的營運。",
    "Learn more ↗" : "取得更多資訊 ↗",
    ...
    "Please make sure to set the \"overwrite.cli.url\" option in your config.php file to the URL that your users mainly use to access this xD Drive. Suggestion: \"{suggestedOverwriteCliURL}\". Otherwise there might be problems with the URL generation via cron. (It is possible though that the suggested URL is not the URL that your users mainly use to access this xD Drive. Best is to double check this in any case.)" : "請確定將 config.php 檔案中的 \"overwrite.cli.url\" 選項設定為您的使用者主要用於存取此 xD Drive 的 URL。建議：\"{suggestedOverwriteCliURL}\"。否則，透過 cron 產生的 URL 可能會出現問題。（不過，建議的 URL 可能不是您的使用者主要用於存取此 xD Drive 的 URL。最好是仔細檢查以防萬一。）",
    ...
    "This instance is missing some recommended PHP modules. For improved performance and better compatibility it is highly recommended to install them." : "您的 xD Drive 缺少了某些建議的 PHP 模組。為了提升效能與相容性，強烈建議您安裝這些 PHP 模組。",
    ...
    "It seems like you are running a 32-bit PHP version. xD Drive 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page ↗{linkend} about this." : "您似乎正在執行 32 位元版本的 PHP。Nextcloud 26 或更新版本需要使用 64 位元的版本。請將您的作業系統與 PHP 升級至 64 位元！要取得更多詳細資訊，請閱讀關於此問題的{linkstart}文件 ↗{linkend}。",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "更新不成功。請在 <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive 社群</a>回報此問題。",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "您似乎正在嘗試重新安裝您的 Nextcloud。然而，檔案 CAN_INSTALL 並不在您的 config 目錄中。請在您的 config 目錄中建立 CAN_INSTALL 檔以繼續。",
    ...
    "This community release of xD Drive is unsupported and instant notifications are unavailable." : "不支援 xD Drive 的這個社群版本，且即時通知不可用。",
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "輸入您的訂閱金鑰以增加使用者限制。要取得更多關於 xD Drive 企業版的資訊，請見我們的網站。",
    "[%d / %d]: Checking table %s" : "[%d / %d]: 檢查資料表 %s",
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications have been disabled to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at nextcloud.com/enterprise." : "這是不受支援的 xD Drive 社群版建置。鑑於此站台的大小，無法保證效能、可靠程度與延展性。推播通知已被停用，以避免我們的免費服務負載過重。請至 nextcloud.com/enterprise 取得更多關於 xD Drive 企業版的資訊。",
    "xD Drive 23 is the last release supporting PHP 7.3. xD Drive 24 requires at least PHP 7.4." : "xD Drive 23 將是支援 PHP 7.3 的最後一個版本，Nextcloud 24 僅支援 PHP 7.4 以上的 PHP。",
    "Some columns in the database are missing a conversion to big int. Due to the fact that changing column types on big tables could take some time they were not changed automatically. By running 'occ db:convert-filecache-bigint' those pending changes could be applied manually. This operation needs to be made while the instance is offline. For further details read {linkstart}the documentation page about this ↗{linkend}." : "資料庫的有些欄位缺少 big int 格式轉換。因為攔位格式轉換需要一些時間，所以沒有自動轉換。你可以執行 \"occ db:convert-filecache-bigin\" 手動完成轉換，轉換時 xD Drive 服務必須處於離線狀態。詳情請參閱{linkstart}關於這個問題的文件頁面 ↗{linkend}。",
    ...
    "It seems like you are running a 32-bit PHP version. xD Drive 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page about this ↗{linkend}." : "您似乎正在執行 32 位元版本的 PHP。Nextcloud 26 或更新版本需要使用 64 位元的版本。請將您的作業系統與 PHP 升級至 64 位元！要取得更多詳細資訊，請閱讀{linkstart}關於此問題的文件 ↗{linkend}。"
},
"nplurals=1; plural=0;");
