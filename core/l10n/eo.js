OC.L10N.register(
    ...
    "xD Drive Server" : "xD Drive-servilo",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "La ĝisdatigo malsukcesis. Bonvolu raporti tiun problemon al la <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive-komunumo</a>.",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "Ŝajnas, ke vi provas reinstali vian xD Drive. Sed la dosiero CAN_INSTALL (angle por „eblo instali“) mankas en via dosierujo „config“. Bv. krei dosieron CAN_INSTALL ene de via dosierujo „config“ por daŭrigi.",
    ...
    "This community release of xD Drive is unsupported and instant notifications are unavailable." : "Tiu elkomunuma eldono de xD Drive ne estas subtenata, kaj tuj-sciigoj ne disponeblas.",
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "Entajpu vian abon-ŝlosilon por pliigi vian maksimuman nombron de uzantoj. Por scii pli pri „Nextcloud Enterprise“, vidu nian retejon.",
