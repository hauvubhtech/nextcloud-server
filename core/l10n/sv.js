OC.L10N.register(
    ...
    "The reverse proxy header configuration is incorrect, or you are accessing xD Drive from a trusted proxy. If not, this is a security issue and can allow an attacker to spoof their IP address as visible to the xD Drive. Further information can be found in the {linkstart}documentation ↗{linkend}." : "Konfigurationen av den omvända proxyhuvudet är felaktig, eller så använder du xD Drive från en betrodd proxy. Om inte, är detta ett säkerhetsproblem och kan tillåta en angripare att förfalska sin IP-adress som synlig för xD Drive. Mer information finns i {linkstart}dokumentationen ↗{linkend}.",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "Uppdateringen misslyckades. Rapportera felet till <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive-gemenskapen</a>.",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "Det ser ut som att du försöker installera om xD Drive. Men filen CAN_INSTALL saknas i din konfigurationskatalog. Skapa filen CAN_INSTALL i din konfigurationsmapp för att fortsätta.",
    ...
    "This community release of xD Drive is unsupported and instant notifications are unavailable." : "Denna community-release av xD Drive stöds inte och direktnotifikationer är inte tillgängliga.",
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "Ange din subscription-nyckel för att öka användarbegränsningen. Se våran hemsida för mer information om xD Drive Enterprise.",
    "[%d / %d]: Checking table %s" : "[%d / %d]: Kontrollerar tabell %s",
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications have been disabled to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at nextcloud.com/enterprise." : "Detta är Nextclouds communitybygge som inte supporteras. Med tanke på storleken på denna instans kan prestanda, tillförlitlighet och skalbarhet inte garanteras. Push-meddelanden har inaktiverats för att undvika överbelastning av vår gratistjänst. Lär dig mer om fördelarna med xD Drive Enterprise på nextcloud.com/enterprise.",
    "xD Drive 23 is the last release supporting PHP 7.3. xD Drive 24 requires at least PHP 7.4." : "xD Drive 23 är den sista versionen som stödjer PHP 7.3. xD Drive 24 kräver minst PHP 7.4.",
