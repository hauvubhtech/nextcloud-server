OC.L10N.register(
    ...
    "This community release of xD Drive is unsupported and push notifications are limited." : "Toto komunitné vydanie xD Drive nie je podporované a push upozornenia nie sú k dispozícii.",
    "Login" : "Prihlásiť sa",
    ...
    "xD Drive Server" : "xD Drive Server",
    ...
    "Please make sure to set the \"overwrite.cli.url\" option in your config.php file to the URL that your users mainly use to access this xD Drive. Suggestion: \"{suggestedOverwriteCliURL}\". Otherwise there might be problems with the URL generation via cron. (It is possible though that the suggested URL is not the URL that your users mainly use to access this xD Drive. Best is to double check this in any case.)" : "Uistite sa, že ste v súbore config.php nastavili možnosť „overwrite.cli.url“ na adresu URL, ktorú vaši užívatelia používajú na prístup k tomuto xD Driveu. Návrh: \"{suggestedOverwriteCliURL}\". V opačnom prípade môžu nastať problémy s generovaním URL cez cron. (Je však možné, že navrhovaná adresa URL nie je adresa URL, ktorú vaši používatelia používajú na prístup k tomuto xD Driveu. Najlepšie je v každom prípade to ešte raz skontrolovať.)",
    ...
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications are limited to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at {linkstart}https://nextcloud.com/enterprise{linkend}." : "Toto je nepodporovaná komunitná verzia xD Drive. Vzhľadom na veľkosť tejto inštancie nemožno zaručiť výkon, spoľahlivosť a škálovateľnosť. Push notifikácie boli deaktivované, aby sa predišlo preťaženiu našej bezplatnej služby. Získajte viac informácií o výhodách xD Drive Enterprise na {linkstart}https://nextcloud.com/enterprise{linkend}.",
    ...
    "It seems like you are running a 32-bit PHP version. xD Drive 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page ↗{linkend} about this." : "Zdá sa, že používate 32-bitovú verziu PHP. xD Drive 26 a vyšší potrebuje 64-bit. Prosím, aktualizujte svoj OS a PHP na 64-bitové! Ďalšie podrobnosti nájdete na {linkstart}stránke dokumentácie↗{linkend}.",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "Aktualizácia bola neúspešná. Oznámte prosím tento problém <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">komunite xD Drive</a>.",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "Vyzerá, že sa snažíte preinštalovať svoj xD Drive. Avšak v adresári s konfiguráciou chýba súbor CAN_INSTALL. Ak chcete pokračovať, tak ho vytvorte.",
    ...
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "Zadaním kľúča na prihlásenie zvýšite limit pre počet užívateľov. Viac informácií o xD Drive Enterprise nájdete na našom webe.",
    "[%d / %d]: Checking table %s" : "[%d / %d]: Kontrola tabuľky %s",
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications have been disabled to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at nextcloud.com/enterprise." : "Toto je nepodporovaná komunitná verzia xD Drive. Vzhľadom na veľkosť tejto inštancie nemožno zaručiť výkon, spoľahlivosť a škálovateľnosť. Push notifikácie boli deaktivované, aby sa predišlo preťaženiu našej bezplatnej služby. Získajte viac informácií o výhodách xD Drive Enterprise na nextcloud.com/enterprise.",
    "xD Drive 23 is the last release supporting PHP 7.3. xD Drive 24 requires at least PHP 7.4." : "xD Drive 23 je posledné vydanie podporujúce PHP 7.3. xD Drive 24 vyžaduje aspoň PHP 7.4.",
    ...
    "It seems like you are running a 32-bit PHP version. xD Drive 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page about this ↗{linkend}." : "Zdá sa, že používate 32-bitovú verziu PHP. xD Drive 26 a vyšší potrebuje 64-bit. Prosím, aktualizujte svoj OS a PHP na 64-bitové! Ďalšie podrobnosti nájdete na {linkstart}stránke dokumentácie↗{linkend}."
},
