OC.L10N.register(
    ...
    "Failed to add the public link to your xD Drive" : "Dodavanje javne poveznice u xD Drive nije uspjelo",
    ...
    "Sharing %s sending the password by xD Drive Talk failed because xD Drive Talk is not enabled" : "Neuspješno dijeljenje %s slanjem zaporke za xD Drive Talk jer xD Drive Talk nije omogućen",
    ...
    "\"Sending the password by xD Drive Talk\" for sharing a file or folder failed because xD Drive Talk is not enabled." : "„Slanje zaporke putem aplikacije xD Drive Talk“ radi dijeljenja datoteke ili mape nije uspjelo jer xD Drive Talk nije omogućen.",
    ...
    "Accept" : "Prihvati",
    "Reject" : "Odbij",
    "This application enables users to share files within xD Drive. If enabled, the admin can choose which groups can share files. The applicable users can then share files and folders with other users and groups within xD Drive. In addition, if the admin enables the share link feature, an external link can be used to share files with other users outside of xD Drive. Admins can also enforce passwords, expirations dates, and enable server to server sharing via share links, as well as sharing from mobile devices.\nTurning the feature off removes shared files and folders on the server for all share recipients, and also on the sync clients and mobile apps. More information is available in the xD Drive Documentation." : "Ova aplikacija omogućuje korisnicima dijeljenje datoteka unutar xD Drive. Ako je omogućena, administrator može odabrati grupe koje mogu dijeliti datoteke. Tada važeći korisnici mogu dijeliti datoteke i mape s drugim korisnicima i grupama unutar xD Drive. Ako administrator omogući značajku poveznice dijeljenja, vanjska poveznica može se koristiti za dijeljenje datoteka s drugim korisnicima izvan xD Drive. Administratori također mogu nametnuti zaporke, datume isteka i omogućiti dijeljenje između poslužitelja putem poveznica za dijeljenje, kao i dijeljenje s mobilnih uređaja.\nIsključivanjem ove značajke uklanjaju se dijeljene datoteke i mape s poslužitelja za sve primatelje dijeljenja, a također i s klijenata za sinkronizaciju i mobilnih aplikacija. Više informacija možete pronaći u xD Driveovoj dokumentaciji.",
    "Sharing" : "Dijeljenje",
    ...
    "Add to your xD Drive" : "Dodaj u svoj xD Drive",
