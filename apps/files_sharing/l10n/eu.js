OC.L10N.register(
    ...
    "Failed to add the public link to your xD Drive" : "Huts egin du esteka publikoa zure xD Drive gehitzean",
    ...
    "Sharing %s sending the password by xD Drive Talk failed because xD Drive Talk is not enabled" : " %s xD Drive Talk-etik pasahitza bidaliz partekatzeak huts egin du, xD Drive Talk ez dagoelako gaituta",
    ...
    "\"Sending the password by xD Drive Talk\" for sharing a file or folder failed because xD Drive Talk is not enabled." : "\"xD Drive Talk-ek pasahitza bidaltzeak\" huts egin du ez dagoelako xD Drive Talk gaituta fitxategi edo karpeta bat partekatzeko.",
    ...
    "Accept" : "Onartu",
    "Reject" : "Ukatu",
    "This application enables users to share files within xD Drive. If enabled, the admin can choose which groups can share files. The applicable users can then share files and folders with other users and groups within xD Drive. In addition, if the admin enables the share link feature, an external link can be used to share files with other users outside of xD Drive. Admins can also enforce passwords, expirations dates, and enable server to server sharing via share links, as well as sharing from mobile devices.\nTurning the feature off removes shared files and folders on the server for all share recipients, and also on the sync clients and mobile apps. More information is available in the xD Drive Documentation." : "Aplikazio honek fitxategiak xD Drive barruan partekatzeko aukera ematen die erabiltzaileei. Gaituz gero, administratzaileak aukeratu dezake zein taldek partekatu ditzaketen fitxategiak. Baimendutako erabiltzaileek xD Drive beste erabiltzaileekin partekatu ditzakete fitxategi eta karpetak. Horretaz gain, administratzaileak esteka partekatzea aukera gaitzen badu, kanpoko esteka bat erabili daiteke xD Drive kanpo dauden erabiltzaileekin fitxategiak partekatzeko. Administratzaileek pasahitzak eta iraungitze-datak betearazi ditzakete, eta zerbitzaritik zerbitzarira partekatze esteka bidez partekatzea gaitu dezakete, baita gailu mugikorretatik partekatzea ere.\nEzaugarria desgaitzeak partekatutako fitxategi eta karpetak kentzen ditu zerbitzaritik partekatzeen hartzaile guztientzat, baita sinkronizatutako bezero eta mugikorreko aplikazioetatik ere. Informazio gehiago eskuragarri dago xD Driveen dokumentazioan.",
    "Sharing" : "Partekatzea",
    ...
    "Add to your xD Drive" : "Gehitu zure xD Driveen",
