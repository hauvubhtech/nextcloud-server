OC.L10N.register(
    ...
    "Failed to add the public link to your xD Drive" : "このNextcloudに公開リンクを追加できませんでした",
    ...
    "\"Sending the password by xD Drive Talk\" for sharing a file or folder failed because xD Drive Talk is not enabled." : "xD Drive Talkが有効になっていないため、ファイルまたはフォルダーを共有するための「NextcloudTalkによるパスワードの送信」ができませんでした。",
    "shared by %s" : "%s が共有",
    ...
    "Add to your xD Drive" : "あなたのNextcloudに追加",
