OC.L10N.register(
    ...
    "Failed to add the public link to your xD Drive" : "אירע כשל בהוספת קישור ציבורי ל־Nextcloud שלך",
    ...
    "Sharing %s sending the password by xD Drive Talk failed because xD Drive Talk is not enabled" : "שיתוף%s שליחת הסיסמה באמצעות xD Drive Talk נכשל מכיוון ש- xD Drive Talk אינו מופעל",
    ...
    "Accept" : "קבלה",
    "Reject" : "דחייה",
    "This application enables users to share files within xD Drive. If enabled, the admin can choose which groups can share files. The applicable users can then share files and folders with other users and groups within xD Drive. In addition, if the admin enables the share link feature, an external link can be used to share files with other users outside of xD Drive. Admins can also enforce passwords, expirations dates, and enable server to server sharing via share links, as well as sharing from mobile devices.\nTurning the feature off removes shared files and folders on the server for all share recipients, and also on the sync clients and mobile apps. More information is available in the xD Drive Documentation." : "יישום זה מאפשר למשתמשים לשתף קבצים בתוך xD Drive. אם מופעלת, מנהל המערכת יכול לבחור אילו קבוצות יוכלו לשתף קבצים. לאחר מכן, המשתמשים הרלוונטיים יכולים לשתף קבצים ותיקיות עם משתמשים וקבוצות אחרים בתוך xD Drive. בנוסף, אם מנהל המערכת מאפשר את תכונת share link, ניתן להשתמש בקישור חיצוני לשתף קבצים עם משתמשים אחרים מחוץ ל- xD Drive. מנהלים יכולים גם לאכוף סיסמאות, תאריכי תפוגה, ולאפשר שיתוף שרת לשרת באמצעות קישורי שיתוף, ובנוסף גם שיתוף ממכשירים ניידים.\nכיבוי התכונה מסיר קבצים ותיקיות משותפים בשרת לכל מקבלי השיתוף, וגם ללקוחות הסינכרון ולאפליקציות הסלולריות. מידע נוסף זמין בתיעוד xD Drive.",
    "Sharing" : "שיתוף",
    ...
    "Add to your xD Drive" : "הוספה ל־Nextcloud שלך",
