OC.L10N.register(
    ...
    "Failed to add the public link to your xD Drive" : "Nem sikerült hozzáadni a nyilvános hivatkozást a Nexcloudjához",
    ...
    "Sharing %s sending the password by xD Drive Talk failed because xD Drive Talk is not enabled" : "A(z) %s megosztás jelszavának xD Drive Beszélgetéssel történő elküldése sikertelen, mert a xD Drive Beszélgetés nem engedélyezett",
    ...
    "\"Sending the password by xD Drive Talk\" for sharing a file or folder failed because xD Drive Talk is not enabled." : "A „Jelszó kiküldése a xD Drive Beszélgetéssel” nem sikerült a fájlnál vagy mappánál, mert a xD Drive Beszélgetés nem engedélyezett.",
    ...
    "Accept" : "Elfogadás",
    "Reject" : "Elutasítás",
    "This application enables users to share files within xD Drive. If enabled, the admin can choose which groups can share files. The applicable users can then share files and folders with other users and groups within xD Drive. In addition, if the admin enables the share link feature, an external link can be used to share files with other users outside of xD Drive. Admins can also enforce passwords, expirations dates, and enable server to server sharing via share links, as well as sharing from mobile devices.\nTurning the feature off removes shared files and folders on the server for all share recipients, and also on the sync clients and mobile apps. More information is available in the xD Drive Documentation." : "Ez az alkalmazás lehetővé teszi a felhasználók számára a fájlok megosztását a xD Driveon belül. Amennyiben engedélyezve van, a rendszergazda kiválaszthatja, hogy mely csoportok oszthassanak meg fájlokat. Az érintett felhasználók ezután megoszthatják a fájlokat és mappákat más felhasználókkal és csoportokkal a xD Driveon belül. Ezenkívül, ha a rendszergazda engedélyezi a megosztás hivatkozással funkciót, akkor egy külső hivatkozás segítségével fájlokat oszthat meg más felhasználókkal a xD Driveon kívül. A rendszergazdák kikényszeríthetik a jelszavakat, a lejárati dátumokat, és engedélyezhetik a megosztási hivatkozásokkal történő kiszolgálók közötti, valamint a mobileszközökön történő megosztást.\nA funkció kikapcsolása eltávolítja a megosztott fájlokat és mappákat a kiszolgálóról az összes megosztott címzett, valamint a szinkronizálási kliensek és mobilalkalmazások számára. További információ a xD Drive dokumentációjában található.",
    "Sharing" : "Megosztás",
    ...
    "Add to your xD Drive" : "Hozzáadás a xD Drivejához",
