OC.L10N.register(
    ...
    "Enabled" : "Povoleno",
    "Disabled" : "Zakázáno",
    "Hey there,\n\nthe admin enabled server-side-encryption. Your files were encrypted using the password \"%s\".\n\nPlease login to the web interface, go to the section \"basic encryption module\" of your personal settings and update your encryption password by entering this password into the \"old log-in password\" field and your current login-password.\n\n" : "Zdravíme,\n\nz důvodu zabezpečení, správce vámi využívané instance xD Drive zapnul šifrování dat na straně serveru. Vaše soubory byly zašifrovány za použití hesla „%s“.\n\nPřihlaste se do webového rozhraní, jděte do nastavení, sekce „základní šifrovací modul“ a aktualizujte šifrovací heslo zadáním výše uvedeného hesla do kolonky „původní přihlašovací heslo“ a pak jako nové nastavte to heslo, kterým se přihlašujete do Nexcloud.\n\n",
    "Hey there,<br><br>the admin enabled server-side-encryption. Your files were encrypted using the password <strong>%s</strong>.<br><br>Please login to the web interface, go to the section \"basic encryption module\" of your personal settings and update your encryption password by entering this password into the \"old log-in password\" field and your current login-password.<br><br>" : "Zdravíme,<br><br>z důvodu zabezpečení, správce vámi využívané instance xD Drive zapnul šifrování dat na straně serveru. Vaše soubory byly zašifrovány za použití hesla <strong>%s<strong>.<br><br>Přihlaste se do webového rozhraní, jděte do nastavení, sekce „základní šifrovací modul“ a aktualizujte šifrovací heslo zadáním výše uvedeného hesla do kolonky „původní přihlašovací heslo“ a pak jako nové nastavte to heslo, kterým se přihlašujete do Nexcloud.<br><br>"
},
