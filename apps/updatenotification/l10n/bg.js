OC.L10N.register(
    ...
    "Please check the xD Drive and server log files for errors." : "Проверете журналите на Nextcloud и на сървъра за грешки.",
    ...
    "Displays update notifications for xD Drive and provides the SSO for the updater." : "Показва известия за актуализация за xD Drive и предоставя SSO за програмата за актуализиране.",
    "Update" : "Обновяване",
    ...
    "<strong>All</strong> apps have a compatible version for this xD Drive version available." : "<strong>Всички</strong>  приложения имат налична съвместима версия за тази версия на xD Drive.",
    "View changelog" : "Преглед на списъка с промени",
    "Enterprise" : "Предприятие",
    "For enterprise use. Provides always the latest patch level, but will not update to the next major release immediately. That update happens once xD Drive GmbH has done additional hardening and testing for large-scale and mission-critical deployments. This channel is only available to customers and provides the xD Drive Enterprise package." : "За професионална употреба. Осигурява винаги най-новото ниво на корекция, но няма да се актуализира веднага до следващото голямо издание. Тази актуализация се случва, след като xD Drive GmbH направи допълнително подсилване и тестване за широкомащабни и критични за мисията внедрявания. Този канал е достъпен само за клиенти и доставчици на пакета xD Drive Enterprise.",
    "Stable" : "Стабилна",
    ...
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available._::_<strong>%n</strong> apps have no compatible version for this xD Drive version available._" : ["<strong>%n</strong> приложения нямат налична съвместима версия за тази версия на xD Drive.","<strong>%n</strong> от приложенията нямат налична съвместима версия за тази версия на xD Drive."],
    "<strong>All</strong> apps have a compatible version for this xD Drive version available" : "<strong>Всички</strong>  приложения имат налична съвместима версия за тази версия на xD Drive",
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available_::_<strong>%n</strong> apps have no compatible version for this xD Drive version available_" : ["<strong>%n</strong> от приложенията нямат налична съвместима версия за тази версия на xD Drive ","<strong>%n</strong> от приложенията нямат налична съвместима версия за тази версия на xD Drive "]
},
