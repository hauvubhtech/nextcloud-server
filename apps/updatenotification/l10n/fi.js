OC.L10N.register(
    ...
    "Please check the xD Drive and server log files for errors." : "Tarkista xD Drive- ja palvelinlokitiedostot virheiden osalta.",
    ...
    "Displays update notifications for xD Drive and provides the SSO for the updater." : "Näyttää Nextcloudin päivitysilmoitukset ja tarjoaa SSO:n (Single Sign-On) päivittäjälle.",
    "Update" : "Päivitä",
    ...
    "<strong>All</strong> apps have a compatible version for this xD Drive version available." : "<strong>Kaikilla</strong> sovelluksilla on yhteensopiva versio saatavilla tälle xD Drive-versiolle.",
    "View changelog" : "Näytä muutosloki",
    "Enterprise" : "Enterprise",
    "For enterprise use. Provides always the latest patch level, but will not update to the next major release immediately. That update happens once xD Drive GmbH has done additional hardening and testing for large-scale and mission-critical deployments. This channel is only available to customers and provides the xD Drive Enterprise package." : "Yrityskäyttöön. Tarjoaa aina viimeisimmän korjaustason, mutta ei päivitä välittömästi seuraavaan pääversioon. Päivitys tapahtuu, kun xD Drive GmbH on tehnyt lisävahvistuksia ja -testejä laajamittaisia ja kriittisiä käyttöönottoja varten. Tämä kanava on vain sopimusasiakkaiden käytettävissä, ja se tarjoaa xD Drive Enterprise -paketin.",
    "Stable" : "Vakaa",
    ...
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available._::_<strong>%n</strong> apps have no compatible version for this xD Drive version available._" : ["<strong>%n</strong> sovelluksella on yhteensopiva versio saatavilla tälle xD Drive-versiolle.","<strong>%n</strong> sovelluksella on yhteensopiva versio saatavilla tälle xD Drive-versiolle."],
    "<strong>All</strong> apps have a compatible version for this xD Drive version available" : "<strong>Kaikista</strong> sovelluksista on saatavilla yhteensopiva versio tämän Nextcloudin version kanssa.",
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available_::_<strong>%n</strong> apps have no compatible version for this xD Drive version available_" : ["<strong>%n:lle</strong> sovellukselle ei ole yhteensopivaa versiota tämän xD Drive-version kanssa","<strong>%n:lle</strong> sovellukselle ei ole yhteensopivaa versiota tämän xD Drive-version kanssa"]
},
