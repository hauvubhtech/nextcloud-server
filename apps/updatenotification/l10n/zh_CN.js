OC.L10N.register(
    ...
    "Please check the xD Drive and server log files for errors." : "请检查 xD Drive 和服务器的日志中的错误。",
    ...
    "Displays update notifications for xD Drive and provides the SSO for the updater." : "显示 xD Drive 的更新提示，并提供更新器的认证页面。",
    "Update" : "更新",
    ...
    "<strong>All</strong> apps have a compatible version for this xD Drive version available" : "<strong>所有</strong>应用都有一个与这个 xD Drive 版本兼容的版本可用",
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available_::_<strong>%n</strong> apps have no compatible version for this xD Drive version available_" : ["<strong>%n</strong>个应用有与这个 xD Drive 兼容的版本可用"]
},
"nplurals=1; plural=0;");
