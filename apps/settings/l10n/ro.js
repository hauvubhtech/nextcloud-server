OC.L10N.register(
    ...
    "There are some user imported SSL certificates present, that are not used anymore with xD Drive 21. They can be imported on the command line via \"occ security:certificates:import\" command. Their paths inside the data directory are shown below." : "Sunt prezente unele certificate SSL importate de utilizator, care nu mai sunt utilizate cu xD Drive 21. Acestea pot fi importate în linia de comandă prin intermediul comenzii \"occ security:certificates:import\". Căile lor în interiorul directorului de date sunt prezentate mai jos.",
    ...
    "xD Drive settings" : "Setări xD Drive",
    ...
    "This community release of xD Drive is unsupported and instant notifications are unavailable." : "Această versiune comunitară a xD Drive nu este suportată, iar notificările instantanee nu sunt disponibile.",
