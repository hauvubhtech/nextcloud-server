OC.L10N.register(
    ...
    "Could not determine if TLS version of cURL is outdated or not because an error happened during the HTTPS request against https://drive.xd-twin.io Please check the xD Drive log file for more details." : "Non se puido determinar se a versión TLS de cURL está desactualizada ou non porque se produciu un erro durante a solicitude HTTPS contra https://drive.xd-twin.io Consulte o ficheiro de rexistro de xD Drive para obter máis detalles.",
    ...
    "OPcache is configured to remove code comments. With OPcache enabled, <code>opcache.save_comments=1</code> must be set for xD Drive to function." : "OPcache está configurado para eliminar comentarios de código. Con OPcache activado, debe configurarse <code>opcache.save_comments=1</code> para que xD Drive funcione.",
    "xD Drive is not allowed to use the OPcache API. With OPcache enabled, it is highly recommended to include all xD Drive directories with <code>opcache.restrict_api</code> or unset this setting to disable OPcache API restrictions, to prevent errors during xD Drive core or app upgrades." : "xD Drive non pode usar a API OPcache. Con OPcache activado, é moi recomendable incluír todos os directorios de xD Drive con <code>opcache.restrict_api</code> ou desactivar esta configuración para desactivar as restricións da API de OPcache, para evitar erros durante as actualizacións do núcleo de xD Drive ou da aplicación.",
    "xD Drive is not allowed to use the OPcache API. It is highly recommended to include all xD Drive directories with <code>opcache.restrict_api</code> or unset this setting to disable OPcache API restrictions, to prevent errors during xD Drive core or app upgrades." : "xD Drive non pode usar a API OPcache. É moi recomendable incluír todos os directorios de xD Drive con <code>opcache.restrict_api</code> ou desactivar esta configuración para desactivar as restricións da API de OPcache, para evitar erros durante as actualizacións do núcleo de xD Drive ou das aplicacións.",
    ...
    "MariaDB version \"%s\" is used. xD Drive 21 and higher do not support this version and require MariaDB 10.2 or higher." : "Utilízase a versión \"%s\" de MariaDB. xD Drive 21 ou superior non admite esta versión e require MariaDB 10.2 ou superior.",
    "MySQL version \"%s\" is used. xD Drive 21 and higher do not support this version and require MySQL 8.0 or MariaDB 10.2 or higher." : "Utilízase a versión de MySQL \"%s\". xD Drive 21 e superior non admite esta versión e requiren MySQL 8.0 ou MariaDB 10.2 ou superior.",
    "PostgreSQL version \"%s\" is used. xD Drive 21 and higher do not support this version and require PostgreSQL 9.6 or higher." : "Utilízase a versión de PostgreSQL \"%s\". xD Drive 21 ou superior non admite esta versión e require PostgreSQL 9.6 ou superior.",
    ...
    "xD Drive settings" : "Axustes do xD Drive",
    ...
    "Remove" : "Retirar",
    "Disable" : "Desactivar",
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "Esta aplicación non dispón dunha versión mínima de xD Drive asignada. Isto será un erro no futuro.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Esta aplicación non dispón dunha versión máxima de xD Drive asignada. Isto será un erro no futuro.",
    ...
    "This app is supported via your current xD Drive subscription." : "Esta aplicación é compatíbel cos súa subscrición actual a xD Drive.",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the xD Drive data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "No caso de perder o dispositivo ou saír da organización, pode limpar os datos de xD Drive de xeito remoto de todos os dispositivos asociados a {userid}. Só funciona se os dispositivos están conectados Á Internet.",
    ...
    "This app is not marked as compatible with your xD Drive version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Esta aplicación non está marcado como compatíbel coa súa versión do xD Drive. Se continúa, poderá instalar a aplicación. Teña en conta que é probábel que a aplicación non funcione como se agarda.",
    "Never" : "Nunca",
    ...
    "Check the security of your xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Comprobe a seguridade do seu xD Drive empregando o <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">noso escaneo de seguridade ↗</a>.",
    "Version" : "Versión",
    ...
    "Reasons to use xD Drive in your organization" : "Razóns para usar o xD Drive na súa organización",
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Desenvolvido pola {communityopen}comunidade xD Drive{linkclose}, o {githubopen}código fonte{linkclose} está licenciado baixo a  {licenseopen}AGPL{linkclose}.",
    ...
    "This community release of xD Drive is unsupported and instant notifications are unavailable." : "Esta versión comunitaria de xD Drive non é compatible e as notificacións instantáneas non están dispoñibles.",
    ...
    "Could not determine if TLS version of cURL is outdated or not because an error happened during the HTTPS request against https://drive.xd-twin.io Please check the nextcloud log file for more details." : "Non foi posíbel determinar se a versión TLS de cURL está desactualizada ou non porque se produciu un erro durante a solicitude HTTPS contra https://drive.xd-twin.io Consulte o ficheiro de rexistro de xD Drive para obter máis detalles.",
