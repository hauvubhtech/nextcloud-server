OC.L10N.register(
    ...
    "xD Drive settings" : "Impostatziones de xD Drive",
    "None" : "Perunu",
    ...
    "Remove" : "Boga",
    "Disable" : "Disativa",
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "Custa aplicatzione non cuntenet sa versione mìnima de xD Drive assignada. At a èssere unu problema in su benidore.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Custa aplicatzione non cuntenet sa versione màssima de xD Drive assignada. At a èssere unu problema in su benidore.",
    ...
    "This app is supported via your current xD Drive subscription." : "Custa aplicatzione est suportada dae sa sutaiscritzione atuale tua in xD Drive.",
    "Supported" : "Suportadu",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the xD Drive data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "In casu de pèrdida de su dispositivu o de essida dae s'organizatzione, custu podet cantzellare dae remotu is datos de xD Drive dae totu is dispositivos assotziados cun {userid}. Funtzionat isceti si is dispositivos sunt collegados a internet. ",
    ...
    "This app is not marked as compatible with your xD Drive version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Custa aplicatzione no est marcada comente cumpatìbile cun sa versione tua de xD Drive. Si sighis, as a pòdere installare s'aplicatzione. Càstia ca podet èssere chi non funtzionet comente prevìdidu.",
    "Never" : "Mai",
    ...
    "Check the security of your xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Controlla sa seguresa de xD Drive in <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">s'iscansione nostra de seguresa ↗</a>.",
    "Version" : "Versione",
    ...
    "Reasons to use xD Drive in your organization" : "Resones pro impreare xD Drive in s'organizatzione tua",
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Isvilupadu dae {communityopen}comunidadexD Drive {linkclose}, su {githubopen}còdighe de orìgine{linkclose} est lissentziadu pro {licenseopen}AGPL{linkclose}.",
    ...
    "If you use third party applications to connect to xD Drive, please make sure to create and configure an app password for each before enabling second factor authentication." : "Si impreas aplicatziones de sa de tres partes pro ti connètere a xD Drive, assegura•ti de creare e cunfigurare una crae pro cada aplicatzione antis de ativare su segundu fatore de autenticatzione.",
    ...
    "Could not determine if TLS version of cURL is outdated or not because an error happened during the HTTPS request against https://drive.xd-twin.io Please check the nextcloud log file for more details." : "Impossìbile a determinare si sa versione TLS de cURL est betza o nono, ca ddoe at àpidu un'errore durante sa dimanda HTTPS in https://drive.xd-twin.io Controlla s'archìviu de registru de nextcloud pro àteros detàllios.",
