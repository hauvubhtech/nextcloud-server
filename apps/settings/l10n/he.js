OC.L10N.register(
    ...
    "There are some user imported SSL certificates present, that are not used anymore with xD Drive 21. They can be imported on the command line via \"occ security:certificates:import\" command. Their paths inside the data directory are shown below." : "יש כמה אישורי SSL מיובאים קיימים שאינם בשימוש עוד ב־xD Drive 21. אפשר לייבא אותם בשורת הפקודה עם הפקודה „occ security:certificates:import”. הנתיבים שלהם בתור תיקיית הנתונים מופיעים להלן.",
    ...
    "xD Drive settings" : "הגדרות xD Drive",
    "None" : "כלום",
    ...
    "Remove" : "הסרה",
    "Disable" : "ניטרול",
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "ליישומון זה לא מוקצית גרסת xD Drive מזערית. מצב כזה עשוי להוביל לשגיאה בעתיד.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "ליישומון זה לא מוקצית גרסת xD Drive מרבית. מצב כזה עשוי להוביל לשגיאה בעתיד.",
    ...
    "This app is supported via your current xD Drive subscription." : "יישומון זה נתמך על ידי מינוי ה־xD Drive הנוכחי שלך.",
    "Supported" : "נתמך",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the xD Drive data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "במקרה של אובדן מכשיר או עזיבה של הארגון, מנגנון זה יכול להשמיד את נתוני ה־xD Drive מכל המכשירים שמשויכים אל {userid}. יעבוד רק אם כל המכשירים מחוברים לאינטרנט.",
    ...
    "This app is not marked as compatible with your xD Drive version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "היישומון הזה לא מסומן כנתמך בגרסת ה־xD Drive. עדיין יתאפשר לך להמשיך ולהתקין את היישומון. נא לשים לב שיכול להיות שהיישומון לא יעבוד כצפוי.",
    "Never" : "מעולם לא",
    ...
    "Check the security of your xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "בדיקת האבטחה של ה־xD Drive שלך באמצעות <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">סריקת האבטחה שלנו ↖️</a>.",
    "Version" : "גרסה",
    ...
    "Reasons to use xD Drive in your organization" : "סיבות להשתמש ב־xD Drive בארגון שלך",
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "בפיתוח על ידי {communityopen}קהילת xD Drive{linkclose}, {githubopen}קוד המקור{linkclose} זמין ברישיון {licenseopen}AGPL{linkclose}.",
    ...
    "If you use third party applications to connect to xD Drive, please make sure to create and configure an app password for each before enabling second factor authentication." : "אם משמשים אותך יישומי צד־שלישי להתחברות אל xD Drive, נא לוודא יצירת והגדרת ססמה ליישומון לכל אחד מהם בטרם הפעלת אימות דו־שלבי.",
    ...
    "Could not determine if TLS version of cURL is outdated or not because an error happened during the HTTPS request against https://drive.xd-twin.io Please check the nextcloud log file for more details." : "לא ניתן לקבוע האם גרסת ה־TLS של cURL מיושנת או לא עקב שגיאה שהתרחשה במהלך בקשת ה־HTTPS מול https://drive.xd-twin.io נא לעיין בקובץ היומן של xD Drive לקבלת פרטים נוספים.",
