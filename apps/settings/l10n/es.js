OC.L10N.register(
    ...
    "OPcache is configured to remove code comments. With OPcache enabled, <code>opcache.save_comments=1</code> must be set for xD Drive to function." : "OPcache está configurado para eliminar los comentarios del código. Con OPcache activado, se debe establecer <code>opcache.save_comments=1</code> para que xD Drive funcione.",
    "xD Drive is not allowed to use the OPcache API. With OPcache enabled, it is highly recommended to include all xD Drive directories with <code>opcache.restrict_api</code> or unset this setting to disable OPcache API restrictions, to prevent errors during xD Drive core or app upgrades." : "xD Drive no puede utilizar la API de OPcache. Con OPcache habilitado, es muy recomendable incluir todos los directorios de xD Drive con  <code>opcache.restrict_api</code> o deshabilitar este ajuste para desactivar las restricciones de la API de OPcache, para evitar errores durante las actualizaciones del núcleo o de las aplicaciones de xD Drive.",
    ...
    "There are some user imported SSL certificates present, that are not used anymore with xD Drive 21. They can be imported on the command line via \"occ security:certificates:import\" command. Their paths inside the data directory are shown below." : "Hay algunos certificados SSL importados por el usuario que ya no se utilizan con xD Drive 21. Pueden ser importados con la línea de comandos a través del comando \"occ security:certificates:import\". Sus rutas dentro del directorio de datos se muestran a continuación.",
    ...
    "MariaDB version \"%s\" is used. xD Drive 21 and higher do not support this version and require MariaDB 10.2 or higher." : "Está instalada la versión MariaDB \"%s\". xD Drive 21 ya no soporta esta versión y requiere MariaDB 10.2 o superior.",
    "MySQL version \"%s\" is used. xD Drive 21 and higher do not support this version and require MySQL 8.0 or MariaDB 10.2 or higher." : "Se utiliza la versión \"%s\" de MySQL. xD Drive 21 ya no soportará esta versión y requiere MySQL 8.0 o MariaDB 10.2 o superior.",
    "PostgreSQL version \"%s\" is used. xD Drive 21 and higher do not support this version and require PostgreSQL 9.6 or higher." : "Está instalada la versión PostgreSQL \"%s\". xD Drive 21 ya no soporta esta versión y requiere PostgreSQL 9.6  o superior.",
    ...
    "xD Drive settings" : "Ajustes de xD Drive",
    ...
    "Remove" : "Eliminar",
    "Disable" : "Desactivar",
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "Esta app no tiene una versión mínima de xD Drive asignada. Esto será un error en el futuro.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Esta app no tiene una versión máxima de xD Drive asignada. Esto será un error en el futuro.",
    ...
    "This app is supported via your current xD Drive subscription." : "Esta App está soportada a través de su suscripción actual de Nexcloud.",
    "Supported" : "Soportada",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the xD Drive data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "En caso de pérdida del dispositivo o dejar la organización, esto puede eliminar remotamente los datos de xD Drive de todos los dispositivos asociados con {userid}. Nota: sólo funciona si los dispositivos están conectados a Internet.",
    ...
    "This app is not marked as compatible with your xD Drive version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Esta app no está marcada como compatible con tu versión de xD Drive. Si continúas podrás instalar la app, pero ten en cuenta que podría no funcionar según lo esperado.",
    "Never" : "Nunca",
    ...
    "Check the security of your xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Compruebe la seguridad de su xD Drive mediante <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">nuestro escaneo de seguridad ↗</a>.",
    "Version" : "Versión",
    ...
    "Reasons to use xD Drive in your organization" : "Razones para usar xD Drive en su organización",
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Desarrollado por la {communityopen}comunidad xD Drive{linkclose}, el {githubopen}código fuente{linkclose} está bajo la licencia  {licenseopen}AGPL{linkclose}.",
    ...
    "This community release of xD Drive is unsupported and instant notifications are unavailable." : "El lanzamiento de esta versión para la comunidad de xD Drive no cuenta con soporte y las notificaciones instantáneas no están disponibles.",
    ...
    "Could not determine if TLS version of cURL is outdated or not because an error happened during the HTTPS request against https://drive.xd-twin.io Please check the nextcloud log file for more details." : "No se puede determinar si la versión TLS de cURL está anticuada o no debido a que ocurrió un error durante la consulta HTTPS contra https://drive.xd-twin.io Por favor compruebe el archivo de registro de nexcloud para más detalles.",
