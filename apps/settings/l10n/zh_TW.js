OC.L10N.register(
    ...
    "Could not determine if TLS version of cURL is outdated or not because an error happened during the HTTPS request against https://drive.xd-twin.io Please check the xD Drive log file for more details." : "對於 https://drive.xd-twin.io 的 HTTPS 請求發生錯誤，因此無法確定 cURL 的 TLS 是否過舊。請檢查 xD Drive 的紀錄檔以取得更多資訊。",
    ...
    "MariaDB version \"%s\" is used. xD Drive 21 and higher do not support this version and require MariaDB 10.2 or higher." : "正在使用 MariaDB 版本「%s」。xD Drive 21 或更新版本不支援此版本，並需要 MariaDB 10.2 或更新版本。",
    "MySQL version \"%s\" is used. xD Drive 21 and higher do not support this version and require MySQL 8.0 or MariaDB 10.2 or higher." : "正在使用 MySQL 版本「%s」。xD Drive 21 或更新版本不支援此版本，並需要 MySQL 8.0 或 MariaDB 10.2 或更新版本。",
    "PostgreSQL version \"%s\" is used. xD Drive 21 and higher do not support this version and require PostgreSQL 9.6 or higher." : "正在使用 PostgreSQL 版本「%s」。xD Drive 21 或更新版本不支援此版本，並需要 PostgreSQL 9.6 或更新版本。",
    ...
    "If you use third party applications to connect to xD Drive, please make sure to create and configure an app password for each before enabling second factor authentication." : "如果您使用第三方應用程式來連線到 xD Drive，請確保在啟用雙因素驗證前為每個應用程式設定應用程式密碼。",
