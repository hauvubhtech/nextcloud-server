OC.L10N.register(
    ...
    "xD Drive settings" : "xD Drive-inställningar",
    ...
    "Remove" : "Ta bort",
    "Disable" : "Inaktivera",
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "Denna app har ingen lägsta xD Drive-version tilldelad. Detta kommer att innebära ett problem i framtiden.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Denna app har ingen minimum xD Drive-version tilldelad. Detta kommer att innebära ett problem i framtiden.",
    ...
    "This app is supported via your current xD Drive subscription." : "Den här appen stöds via ditt nuvarande xD Drive-abonnemang.",
    "Supported" : "Stöds",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the xD Drive data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "Om användaren förlorar sin enhet eller lämnar organisationen, kan all xD Drive-data fjärrensas från alla enheter associerade med {userid}. Fungerar bara om enheterna är anslutna till internet.",
    ...
    "This app is not marked as compatible with your xD Drive version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Den här appen är inte markerad som kompatibel med din xD Drive-version. Om du fortsätter kan du fortfarande installera appen. Observera att appen kanske inte fungerar som förväntat.",
    "Never" : "Aldrig",
    ...
    "Check the security of your xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Kontrollera säkerheten för ditt xD Drive över <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">vår säkerhetsgenomsökning ↗</a>.",
    "Version" : "Version",
    ...
    "Reasons to use xD Drive in your organization" : "Anledningar att använda xD Drive i din organisation",
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Utvecklat av {communityopen}xD Drive-gemenskapen{linkclose}, {githubopen}källkoden{linkclose}  är licensierad enligt {licenseopen}AGPL-standard{linkclose}.",
    ...
    "If you use third party applications to connect to xD Drive, please make sure to create and configure an app password for each before enabling second factor authentication." : "Om du använder tredje-parts applikationer för att ansluta till xD Drive vänligen skapa och konfigurera ett applösenord för varje innan två-faktor autentisering aktiveras.",
