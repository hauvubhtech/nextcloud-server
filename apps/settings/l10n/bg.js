OC.L10N.register(
    ...
    "Could not determine if TLS version of cURL is outdated or not because an error happened during the HTTPS request against https://drive.xd-twin.io Please check the xD Drive log file for more details." : "Не можа да се определи дали TLS версията на cURL е остаряла или не, защото възникна грешка по време на HTTPS заявката срещу https://drive.xd-twin.io Моля, проверете регистрационния файл /журнал/ на  xD Drive за повече подробности.",
    ...
    "OPcache is configured to remove code comments. With OPcache enabled, <code>opcache.save_comments=1</code> must be set for xD Drive to function." : "OPcache е конфигуриран за премахване на кодови коментари. С активиран OPcache, <code>opcache.save_comments=1</code> трябва да бъде настроен за xD Drive, за да функционира.",
    "xD Drive is not allowed to use the OPcache API. With OPcache enabled, it is highly recommended to include all xD Drive directories with <code>opcache.restrict_api</code> or unset this setting to disable OPcache API restrictions, to prevent errors during xD Drive core or app upgrades." : "xD Drive няма право да използва OPcache API. При активиран OPcache е силно препоръчително да включите всички директории xD Drive с <code>opcache.restrict_api</code> или деактивирайте тази настройка, за да деактивирате ограниченията на OPcache API, за да предотвратите грешки по време на надстройки на ядрото или приложението на xD Drive.",
    "xD Drive is not allowed to use the OPcache API. It is highly recommended to include all xD Drive directories with <code>opcache.restrict_api</code> or unset this setting to disable OPcache API restrictions, to prevent errors during xD Drive core or app upgrades." : "xD Drive няма право да използва OPcache API. Силно препоръчително е да включите всички директории xD Drive с <code>opcache.restrict_api</code> или деактивирайте тази настройка, за да деактивирате ограниченията на OPcache API, за да предотвратите грешки по време на надстройки на ядрото или приложението на xD Drive.",
    ...
    "MariaDB version \"%s\" is used. xD Drive 21 and higher do not support this version and require MariaDB 10.2 or higher." : "Използва се версия на MariaDB „%s “. xD Drive 21 и по-новите версии вече няма да поддържат тази версия и се изисква MariaDB 10.2 или по-нова версия.",
    "MySQL version \"%s\" is used. xD Drive 21 and higher do not support this version and require MySQL 8.0 or MariaDB 10.2 or higher." : "Използва се версия на MySQL „ %s“. xD Drive 21 и по-новите версии вече няма да поддържат тази версия и се изискват MySQL 8.0 или MariaDB 10.2, или по-нова версия.",
    "PostgreSQL version \"%s\" is used. xD Drive 21 and higher do not support this version and require PostgreSQL 9.6 or higher." : "Използва се PostgreSQL версия „%s “. xD Drive 21 и по-новите версии вече няма да поддържат тази версия и се изисква PostgreSQL 9.6 или по-нова версия.",
    ...
    "xD Drive settings" : "xD Drive настройки",
    ...
    "Remove" : "Премахване",
    "Disable" : "Изключване",
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "Това приложение няма присвоена минимална версия на xD Drive. В бъдеще това ще бъде грешка.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Това приложение няма зададена максимална версия на xD Drive. В бъдеще това ще бъде грешка.",
    ...
    "This app is supported via your current xD Drive subscription." : "Това приложение се поддържа чрез текущия ви абонамент за xD Drive.",
    "Supported" : "Поддържан",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the xD Drive data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "В случай на изгубено устройство или излизане от организацията, това може отдалечено да изтрие данните на xD Drive от всички устройства, свързани с {userid}. Работи, само ако устройствата са свързани към интернет.",
    ...
    "This app is not marked as compatible with your xD Drive version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Приложението не е маркирано като съвместимо с вашата версия на xD Drive. Можете да инсталирате приложението, но е вероятно да не работи безпроблемно.",
    "Never" : "Никога",
    ...
    "It is important to set up this server to be able to send emails, like for password reset and notifications." : "След като настроите сървъра xD Drive ще може да изпраща имейли за възстановяване на забравени пароли и известия.",
    ...
    "There are some errors regarding your setup." : "Открити са грешки, в инсталацията на xD Drive.",
    ...
    "Check the security of your xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Проверете сигурността на xD Drive <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">като заявите сканиране ↗</a>.",
    "Version" : "Версия",
    ...
    "Reasons to use xD Drive in your organization" : "Причини да използвате xD Drive във вашата организация",
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Разработен от {communityopen}общността на xD Drive{linkclose}, {githubopen}изходният код{linkclose} е лицензиран под {licenseopen}AGPL{linkclose}.",
    ...
    "This community release of xD Drive is unsupported and instant notifications are unavailable." : "Тази общностна версия на xD Drive не се поддържа и не са налични незабавни известия.",
    ...
    "If you use third party applications to connect to xD Drive, please make sure to create and configure an app password for each before enabling second factor authentication." : "Ако използвате приложения на трети страни, за да се свържете с xD Drive, моля, не забравяйте да създадете и конфигурирате парола за приложение за всяко едно от тях, преди да активирате удостоверяване на втория фактор.",
    ...
    "Could not determine if TLS version of cURL is outdated or not because an error happened during the HTTPS request against https://drive.xd-twin.io Please check the nextcloud log file for more details." : "Не можа да се определи дали TLS версията на cURL е остаряла или не, защото възникна грешка по време на HTTPS заявката срещу https://drive.xd-twin.io Моля, проверете регистрационния файл на nextcloud за повече подробности.",
