OC.L10N.register(
    ...
    "There are some user imported SSL certificates present, that are not used anymore with xD Drive 21. They can be imported on the command line via \"occ security:certificates:import\" command. Their paths inside the data directory are shown below." : "Der er nogle brugerimporterede SSL-certifikater til stede, som ikke længere bruges med xD Drive 21. De kan importeres på kommandolinjen via kommandoen \"occ security:certificates:import\". Deres stier inde i databiblioteket er vist nedenfor.",
    ...
    "xD Drive settings" : "xD Drive-indstillinger",
    ...
    "Remove" : "Fjern",
    "Disable" : "Deaktiver",
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "Denne app har ikke angivet en mindste understøttede version af xD Drive. I fremtiden vil det være en fejl.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Denne app har ikke angivet en højeste understøttede version af xD Drive. I fremtiden vil det være en fejl.",
    ...
    "This app is supported via your current xD Drive subscription." : "Denne app understøttes via dit nuværende xD Drive-abonnement.",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the xD Drive data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "I tilfælde af tabt enhed eller forlader organisationen, kan dette fjernslette xD Drive-dataene fra alle enheder, der er knyttet til {userid}. Virker kun, hvis enhederne er forbundet til internettet.",
    ...
    "This app is not marked as compatible with your xD Drive version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Denne app er ikke markeret som kompatibel med din xD Drive-version. Hvis du fortsætter, vil du stadig være i stand til at installere appen. Bemærk, at appen muligvis ikke fungerer som forventet.",
    "Never" : "Aldrig",
    ...
    "Check the security of your xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Tjek sikkerheden på din xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">vores sikkerhedsscanning ↗</a>.",
    "Version" : "Version",
    ...
    "Reasons to use xD Drive in your organization" : "Grunde til at bruge xD Drive i din organisation",
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Udviklet af {communityopen}xD Drive fællesskabet{linkclose}, {githubopen}kildekoden{linkclose} er udgivet med {licenseopen}AGPL{linkclose} licensen.",
    ...
    "This community release of xD Drive is unsupported and instant notifications are unavailable." : "Denne fællesskabsudgivelse af xD Drive er ikke understøttet, og øjeblikkelige meddelelser er ikke tilgængelige.",
