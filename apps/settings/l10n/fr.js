OC.L10N.register(
    ...
    "OPcache is configured to remove code comments. With OPcache enabled, <code>opcache.save_comments=1</code> must be set for xD Drive to function." : "OPcache est configuré pour retirer les commentaires du code. Avec OPcache activé, <code>opcache.save_comments=1</code> doit être ajouté au fichier de configuration PHP pour que xD Drive fonctionne.",
    "xD Drive is not allowed to use the OPcache API. With OPcache enabled, it is highly recommended to include all xD Drive directories with <code>opcache.restrict_api</code> or unset this setting to disable OPcache API restrictions, to prevent errors during xD Drive core or app upgrades." : "xD Drive n'est pas autorisé à utiliser l'API de OPcache. Avec OPcache activé, il est fortement recommandé d'inclure tous les répertoires de xD Drive dans la variable <code>opcache.restrict_api</code> du fichier de configuration PHP ou de désactiver ces restrictions de l'API OPcache, pour éviter les erreurs pendant les mises à jour de xD Drive ou des applications.",
    "xD Drive is not allowed to use the OPcache API. It is highly recommended to include all xD Drive directories with <code>opcache.restrict_api</code> or unset this setting to disable OPcache API restrictions, to prevent errors during xD Drive core or app upgrades." : "xD Drive n'est pas autorisé à utiliser l'API de OPcache. Il est fortement recommandé d'inclure tous les répertoires de xD Drive dans la variable 1opcache.restrict_api1 du fichier de configuration PHP ou de désactiver ces restrictions de l'API OPcache, pour éviter les erreurs pendant les mises à jour de xD Drive ou des applications.",
    ...
    "MariaDB version \"%s\" is used. xD Drive 21 and higher do not support this version and require MariaDB 10.2 or higher." : "MariaDB version \"%s\" est utilisé. xD Drive 21 et plus ne sont plus compatibles avec cette version et nécessitent MariaDB 10.2 ou plus.",
    "MySQL version \"%s\" is used. xD Drive 21 and higher do not support this version and require MySQL 8.0 or MariaDB 10.2 or higher." : "MySQL version \"%s\" est utilisé. xD Drive 21 et plus ne sont plus compatibles avec cette version et nécessitent MySQL 8.0 or MariaDB 10.2 ou plus.",
    "PostgreSQL version \"%s\" is used. xD Drive 21 and higher do not support this version and require PostgreSQL 9.6 or higher." : "PostgreSQL version \"%s\" est utilisé. xD Drive 21 et plus ne sont plus compatibles avec cette version et nécessitent PostgreSQL 9.6 ou plus.",
    ...
    "xD Drive settings" : "Paramètres xD Drive",
    ...
    "Remove" : "Supprimer",
    "Disable" : "Désactiver",
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "Cette application n'a pas de version minimum xD Drive exigée. Ce sera considéré comme une erreur à l'avenir.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Cette application n'a pas de version maximum xD Drive exigée. Ce sera considéré comme une erreur à l'avenir.",
    ...
    "This app is supported via your current xD Drive subscription." : "Cette application bénéficie d'un support grâce à votre abonnement xD Drive.",
    ...
    "Choose profile picture from files" : "Choisir une photo de profil dans les fichiers de xD Drive",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the xD Drive data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "En cas de perte d'appareil ou si vous quittez un groupe ou une organisation, cette appli supprimera les données de tous les appareils associés à {userid}. Ne fonctionne que si les appareils associés sont connecté à internet.",
    ...
    "This app is not marked as compatible with your xD Drive version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Cette application n'est pas indiquée comme étant compatible avec votre version de xD Drive. Si vous continuez vous pourrez toujours installer l'app. Notez cependant qu'elle pourrait ne pas fonctionner comme prévu.",
    "Never" : "Jamais",
    ...
    "It's important for the security and performance of your instance that everything is configured correctly. To help you with that we are doing some automatic checks. Please see the linked documentation for more information." : "Il est important pour la sécurité et la performance de votre instance que celle-ci soit correctement configurée. Afin de vous aider, votre instance xD Drive effectue des vérifications automatiques. Pour de plus amples informations, veuillez consulter la documentation liée.",
    ...
    "Check the security of your xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Vérifier la sécurité de votre xD Drive grâce à <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">notre scan de sécurité ↗</a>",
    "Version" : "Version",
    ...
    "Reasons to use xD Drive in your organization" : "Pourquoi utiliser xD Drive dans votre organisation ?",
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Développé par la {communityopen}communauté xD Drive{linkclose}, le {githubopen}code source{linkclose} est sous licence {licenseopen}AGPL{linkclose}.",
    ...
    "This community release of xD Drive is unsupported and instant notifications are unavailable." : "Cette version communautaire de xD Drive n'est pas supportée et les notifications push ne sont pas disponibles.",
    ...
    "You need to migrate your encryption keys from the old encryption (ownCloud <= 8.0) to the new one." : "Vous devez migrer vos clés de chiffrement de l'ancienne (ownCloud <= 8.0) vers la nouvelle.",
    ...
    "For the server to work properly, it's important to configure background jobs correctly. \"Cron\" is the recommended setting. Please see the documentation for more information." : "Pour que le serveur fonctionne correctement, il est important de configurer correctement les tâches d'arrière-plan. \"Cron\" est le règlage recommandé. Veuillez vous référer à la documentation xD Drive pour plus d'informations.",
