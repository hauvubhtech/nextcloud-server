OC.L10N.register(
    ...
    "Remove" : "Šalinti",
    "Disable" : "Išjungti",
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "Ši programėlė neturi priskirtos žemiausios „xD Drive“ versijos. Ateityje tai bus klaida.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Ši programėlė neturi priskirtos aukščiausios „xD Drive“ versijos. Ateityje tai bus klaida.",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the xD Drive data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "Pametus įrenginį arba pasikeitus darbo santykiams su organizacija, galima nuotoliniu būdu išvalyti „xD Drive“ duomenis iš visų įrenginių, susietų su {userid}.  Veikia tik su prie interneto prijungtais įrenginiais.",
