OC.L10N.register(
    ...
    "Could not determine if TLS version of cURL is outdated or not because an error happened during the HTTPS request against https://drive.xd-twin.io Please check the xD Drive log file for more details." : "Nie można określić, czy wersja TLS cURL jest aktualna, ponieważ wystąpił błąd podczas żądania HTTPS skierowanego do https://drive.xd-twin.io Aby uzyskać więcej informacji, sprawdź plik dziennika xD Drive.",
    ...
    "OPcache is configured to remove code comments. With OPcache enabled, <code>opcache.save_comments=1</code> must be set for xD Drive to function." : "OPcache jest skonfigurowane do usuwania komentarzy kodu. Przy włączonym OPcache, musi być ustawione <code>opcache.save_comments=1</code>, aby działał xD Drive.",
    "xD Drive is not allowed to use the OPcache API. With OPcache enabled, it is highly recommended to include all xD Drive directories with <code>opcache.restrict_api</code> or unset this setting to disable OPcache API restrictions, to prevent errors during xD Drive core or app upgrades." : "xD Drive nie może korzystać z interfejsu OPcache API. Po włączeniu OPcache zdecydowanie zaleca się uwzględnienie wszystkich katalogów xD Drive z <code>opcache.restrict_api</code> lub usunięcie tego ustawienia, aby wyłączyć ograniczenia interfejsu OPcache API, żeby zapobiec błędom podczas aktualizacji rdzenia lub aplikacji xD Drive.",
    ...
    "MariaDB version \"%s\" is used. xD Drive 21 and higher do not support this version and require MariaDB 10.2 or higher." : "Używana jest wersja MariaDB \"%s\". xD Drive 21 i nowsze wersje nie obsługują tej wersji i wymagają MariaDB 10.2 lub nowszej.",
    "MySQL version \"%s\" is used. xD Drive 21 and higher do not support this version and require MySQL 8.0 or MariaDB 10.2 or higher." : "Używana jest wersja MySQL \"%s\". xD Drive 21 i nowsze wersje nie obsługują tej wersji i wymagają MySQL 8.0 lub MariaDB 10.2, albo nowszej.",
    "PostgreSQL version \"%s\" is used. xD Drive 21 and higher do not support this version and require PostgreSQL 9.6 or higher." : "Używana jest wersja PostgreSQL \"%s\". xD Drive 21 i nowsze wersje nie obsługują tej wersji i wymagają PostgreSQL 9.6 lub nowszej.",
    ...
    "xD Drive settings" : "Ustawienia xD Drive",
    ...
    "Remove" : "Usuń",
    "Disable" : "Wyłącz",
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "Ta aplikacja nie ma przypisanej minimalnej wersji xD Drive. W przyszłości będzie to błąd.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Ta aplikacja nie ma przypisanej maksymalnej wersji xD Drive. W przyszłości będzie to błąd.",
    ...
    "This app is supported via your current xD Drive subscription." : "Ta aplikacja jest obsługiwana za pośrednictwem bieżącej subskrypcji xD Drive.",
    "Supported" : "Wspierany",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the xD Drive data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "W przypadku zagubienia urządzenia lub opuszczenia organizacji można zdalnie wyczyścić dane xD Drive ze wszystkich urządzeń powiązanych z {userid}. Działa tylko wtedy, gdy urządzenia są podłączone do Internetu.",
    ...
    "This app is not marked as compatible with your xD Drive version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Ta aplikacja jest niezgodna z wersją xD Drive. Przy dalszej kontynuacji, możesz pozwolić na zainstalowanie tej aplikacji. Pamiętaj, że aplikacja może nie działać zgodnie z oczekiwaniami.",
    "Never" : "Nigdy",
    ...
    "Check the security of your xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Sprawdź bezpieczeństwo swojego serwera xD Drive <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">naszym skanerem bezpieczeństwa ↗</a>.",
    "Version" : "Wersja",
    ...
    "Reasons to use xD Drive in your organization" : "Dlaczego warto korzystać z xD Drive w Twojej organizacji",
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Opracowane przez {communityopen}społeczność xD Drive{linkclose}, {githubopen}kod źródłowy{linkclose} jest objęty licencją {licenseopen}AGPL{linkclose}.",
    ...
    "This community release of xD Drive is unsupported and instant notifications are unavailable." : "To wydanie społecznościowe xD Drive nie jest obsługiwane i powiadomienia natychmiastowe są niedostępne.",
    ...
    "If you use third party applications to connect to xD Drive, please make sure to create and configure an app password for each before enabling second factor authentication." : "Jeśli używasz aplikacji innych firm do łączenia się z xD Drive, upewnij się, że utworzyłeś i skonfigurowałeś hasło aplikacji dla każdej przed włączeniem uwierzytelniania dwuskładnikowego.",
