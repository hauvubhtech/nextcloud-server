OC.L10N.register(
    ...
    "OPcache is configured to remove code comments. With OPcache enabled, <code>opcache.save_comments=1</code> must be set for xD Drive to function." : "OPcache è configurato per rimuovere i commenti di codice. Con OPcache attivato, <code>opcache.save_comments=1</code> deve essere impostato affinché xD Drive funzioni.",
    ...
    "xD Drive settings" : "Impostazioni di xD Drive",
    ...
    "Remove" : "Rimuovi",
    "Disable" : "Disabilita",
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "Questa applicazione non contiene l'informazione della versione minima di xD Drive richiesta. In futuro ciò sarà considerato un errore.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Questa applicazione non contiene l'informazione della versione massima di xD Drive richiesta. In futuro ciò sarà considerato un errore.",
    ...
    "This app is supported via your current xD Drive subscription." : "Questa applicazione è supportata tramite la tua sottoscrizione attuale di xD Drive.",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the xD Drive data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "In caso di smarrimento di un dispositivo o uscita dall'organizzazione, questa funzione può cancellare a distanza i dati di xD Drive da tutti i dispositivi associati a {userid}. Funziona solo se i dispositivi sono connessi a Internet.",
    ...
    "This app is not marked as compatible with your xD Drive version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Questa applicazione non è marcata come compatibile con la tua versione di xD Drive. Se continui sarai ancora in grado di installare l'applicazione. Nota che l'applicazione potrebbe non funzionare come previsto.",
    "Never" : "Mai",
    ...
    "Check the security of your xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Controlla la sicurezza del tuo xD Drive con la <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">nostra scansione di sicurezza ↗</a>",
    "Version" : "Versione",
    ...
    "Reasons to use xD Drive in your organization" : "Motivi per utilizzare xD Drive nella tua organizzazione",
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Sviluppato dalla {communityopen}comunità di xD Drive{linkclose}, il {githubopen}codice sorgente{linkclose} è rilasciato nei termini della licenza {licenseopen}AGPL{linkclose}.",
    ...
    "This community release of xD Drive is unsupported and instant notifications are unavailable." : "Questa versione di xD Drive della community non è supportata e le notifiche istantanee non sono disponibili.",
    ...
    "Could not determine if TLS version of cURL is outdated or not because an error happened during the HTTPS request against https://drive.xd-twin.io Please check the nextcloud log file for more details." : "Impossibile determinare se la versione TLS di cURL è obsoleta o meno perché si è verificato un errore durante la richiesta HTTPS su https://drive.xd-twin.io Controlla il file di registro di nextcloud per maggiori dettagli.",
