OC.L10N.register(
    ...
    "Could not determine if TLS version of cURL is outdated or not because an error happened during the HTTPS request against https://drive.xd-twin.io Please check the xD Drive log file for more details." : "No s'ha pogut determinar si la versió TLS de cURL està obsoleta o no perquè s'ha produït un error durant la sol·licitud HTTPS contra https://drive.xd-twin.io Comproveu el fitxer de registre de xD Drive per obtenir més detalls.",
    ...
    "OPcache is configured to remove code comments. With OPcache enabled, <code>opcache.save_comments=1</code> must be set for xD Drive to function." : "OPcache està configurat per suprimir comentaris de codi. Amb OPcache habilitat, s'ha d'establir <code>opcache.save.comments=1</code> perquè xD Drive funcioni.",
    "xD Drive is not allowed to use the OPcache API. With OPcache enabled, it is highly recommended to include all xD Drive directories with <code>opcache.restrict_api</code> or unset this setting to disable OPcache API restrictions, to prevent errors during xD Drive core or app upgrades." : "xD Drive no té permís per utilitzar l'API OPcache. Amb OPcache habilitat, us recomanem que inclogueu tots els directoris xD Drive amb <code>opcache.restrict.api</code> o que desconfigureu aquest paràmetre per inhabilitar les restriccions de l'API OPcache i evitar errors durant les actualitzacions del nucli de xD Drive o de l'aplicació.",
    "xD Drive is not allowed to use the OPcache API. It is highly recommended to include all xD Drive directories with <code>opcache.restrict_api</code> or unset this setting to disable OPcache API restrictions, to prevent errors during xD Drive core or app upgrades." : "xD Drive no té permís per utilitzar l'API OPcache. Us recomanem que inclogueu tots els directoris xD Drive amb <code>1opcache.restrict.api1</code> o que desconfigureu aquest paràmetre per inhabilitar les restriccions de l'API OPcache i evitar errors durant les actualitzacions del nucli de xD Drive o de l'aplicació.",
    ...
    "There are some user imported SSL certificates present, that are not used anymore with xD Drive 21. They can be imported on the command line via \"occ security:certificates:import\" command. Their paths inside the data directory are shown below." : "Hi ha alguns certificats SSL importats per l'usuari que ja no s'utilitzen amb xD Drive 21. Es poden importar en la línia d'ordres a través de l'ordre «occ security:certificates:import». A continuació se'n mostren els camins dins del directori de dades.",
    ...
    "MariaDB version \"%s\" is used. xD Drive 21 and higher do not support this version and require MariaDB 10.2 or higher." : "S'utilitza la versió \"%s\" de MariaDB . xD Drive 21 i les versions superiors no admeten aquesta versió i requereixen MariaDB 10.2 o superior.",
    "MySQL version \"%s\" is used. xD Drive 21 and higher do not support this version and require MySQL 8.0 or MariaDB 10.2 or higher." : "S'utilitza la versió \"%s\" de MariaDB . xD Drive 21 i les versions superiors no admeten aquesta versió i requereixen MySQL 8.0 o MariaDB 10.2 o superior.",
    "PostgreSQL version \"%s\" is used. xD Drive 21 and higher do not support this version and require PostgreSQL 9.6 or higher." : "S'utilitza la versió \"%s\" de PostgreSQL . xD Drive 21 i les versions superiors no admeten aquesta versió i requereixen PostgreSQL 9.6 o superior.",
    ...
    "xD Drive settings" : "Paràmetres del xD Drive",
    ...
    "Remove" : "Suprimeix",
    "Disable" : "Inhabilita",
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "Aquesta aplicació no té cap versió mínima de xD Drive assignada. Això serà un error en el futur.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Aquesta aplicació no té cap versió màxima de xD Drive assignada. Això serà un error en el futur.",
    ...
    "This app is supported via your current xD Drive subscription." : "Aquesta aplicació és compatible amb la vostra subscripció actual a xD Drive.",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the xD Drive data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "En cas de perdre un dispositiu o sortir de l’organització, es pot esborrar de forma remota les dades del xD Drive de tots els dispositius associats a {userid}. Només funciona si els dispositius estan connectats a Internet.",
    ...
    "This app is not marked as compatible with your xD Drive version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Aquesta aplicació no està marcada com a compatible amb la vostra versió de xD Drive. Si continueu, encara podreu instal·lar l’aplicació. Tingueu en compte que pot ser que l’aplicació no funcioni correctament.",
    "Never" : "Mai",
    ...
    "Check the security of your xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Reviseu la seguretat del vostre xD Drive mitjançant el <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">nostre escaneig de seguretat ↗</a>.",
    "Version" : "Versió",
    ...
    "Reasons to use xD Drive in your organization" : "Motius per a utilitzar xD Drive en la vostra organització",
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Desenvolupat per la {communityopen}comunitat xD Drive{linkclose}, el {githubopen}codi font{linkclose} es troba sota la llicència {licenseopen}AGPL{linkclose}.",
    ...
    "This community release of xD Drive is unsupported and instant notifications are unavailable." : "Aquest llançament de la comunitat de xD Drive no és compatible i les notificacions instantànies no estan disponibles.",
    ...
    "Could not determine if TLS version of cURL is outdated or not because an error happened during the HTTPS request against https://drive.xd-twin.io Please check the nextcloud log file for more details." : "No s'ha pogut determinar si la versió TLS de cURL està obsoleta o no perquè s'ha produït un error durant la sol·licitud HTTPS a https://drive.xd-twin.io Si us plau, comproveu el fitxer de registre nextcloud per obtenir més detalls.",
