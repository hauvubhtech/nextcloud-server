OC.L10N.register(
    ...
    "xD Drive settings" : "xD Drive-asetukset",
    ...
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "Tämä sovellus ei ole määritellyt minimi xD Drive-versiota. Tämä tulee olemaan ongelma tulevaisuudessa.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Tämä sovellus ei ole määritellyt maksimi xD Drive-versiota. Tämä tulee olemaan ongelma tulevaisuudessa.",
    ...
    "This app is supported via your current xD Drive subscription." : "Tämä sovellus on tuettu nykyisen xD Drive-tilauksesi kautta.",
    "Supported" : "Tuettu",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the xD Drive data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "Laitteen kadotessa tai organisaatiosta poistuessa voidaan käyttäjälle {userid} xD Driveiin yhdistetyistä laitteista pyyhkiä  tiedot. Toimii vain laitteiden ollessa yhteydessä Internetiin.",
    ...
    "This app is not marked as compatible with your xD Drive version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Sovellusta ei ole merkattu yhteensopivaksi xD Drive-versiosi kanssa. Voit kuitenkin jatkaa ja asentaa sovelluksen. Huomioi, että sovellus ei välttämättä toimi odotetusti.",
    "Never" : "Ei koskaan",
    ...
    "Check the security of your xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Tarkista xD Driveisi turvallisuus käyttäen <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">tietoturvakartoitustamme ↗</a>.",
    "Version" : "Versio",
    ...
    "Reasons to use xD Drive in your organization" : "xD Drivein käytön edut organisaatiossasi",
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Kehityksestä on vastannut {communityopen}xD Drive-yhteisö{linkclose}, {githubopen}lähdekoodi{linkclose} on {licenseopen}AGPL-lisensoitu{linkclose}.",
    ...
    "This community release of xD Drive is unsupported and instant notifications are unavailable." : "Tätä yhteisöjulkaisua xD Driveista ei tueta, ja pikailmoitukset eivät ole saatavilla.",
