OC.L10N.register(
    ...
    "OPcache is configured to remove code comments. With OPcache enabled, <code>opcache.save_comments=1</code> must be set for xD Drive to function." : "OPcache está configurado para remover comentários de código. Com o OPcache ativado, <code>opcache.save_comments=1</code> deve ser definido para que o xD Drive funcione.",
    "xD Drive is not allowed to use the OPcache API. With OPcache enabled, it is highly recommended to include all xD Drive directories with <code>opcache.restrict_api</code> or unset this setting to disable OPcache API restrictions, to prevent errors during xD Drive core or app upgrades." : "O xD Drive não tem permissão para usar a API OPcache. Com o OPcache ativado, é altamente recomendável incluir todos os diretórios do xD Drive com <code>opcache.restrict_api</code>ou desmarque essa configuração para desabilitar as restrições da API OPcache, para evitar erros durante o núcleo do xD Drive ou atualizações de aplicativos.",
    "xD Drive is not allowed to use the OPcache API. It is highly recommended to include all xD Drive directories with <code>opcache.restrict_api</code> or unset this setting to disable OPcache API restrictions, to prevent errors during xD Drive core or app upgrades." : "O xD Drive não tem permissão para usar a API OPcache. É altamente recomendável incluir todos os diretórios do xD Drive com <code>opcache.restrict_api</code> ou desmarque essa configuração para desabilitar as restrições da API OPcache, para evitar erros durante o núcleo do xD Drive ou atualizações de aplicativos.",
    ...
    "MariaDB version \"%s\" is used. xD Drive 21 and higher do not support this version and require MariaDB 10.2 or higher." : "A versão do MariaDB \"1%s\" está sendo usada. xD Drive 21 e superior não suportam esta versão e requerem MariaDB 10.2 ou superior.",
    "MySQL version \"%s\" is used. xD Drive 21 and higher do not support this version and require MySQL 8.0 or MariaDB 10.2 or higher." : "A versão do MySQL \"1%s\" está sendo usada. xD Drive 21 e superior não suportam esta versão e requerem MySQL 8.0 ou MariaDB 10.2 ou superior.",
    "PostgreSQL version \"%s\" is used. xD Drive 21 and higher do not support this version and require PostgreSQL 9.6 or higher." : "A versão do PostgreSQL \"1%s\" está sendo usada. xD Drive 21 e superior não suportam esta versão e requerem o PostgreSQL 9.6 ou superior.",
    ...
    "xD Drive settings" : "Configurações xD Drive",
    ...
    "Remove" : "Excluir",
    "Disable" : "Desativar",
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "Este aplicativo não possui uma versão mínima atribuída para uso no xD Drive. Isto poderá se converter em um erro no futuro.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Este aplicativo não possui uma versão máxima atribuida para uso no xD Drive. Isto poderá se converter em um erro no futuro.",
    ...
    "This app is supported via your current xD Drive subscription." : "Este aplicativo é suportado pela sua assinatura atual do xD Drive.",
    "Supported" : "Suportado",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the xD Drive data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "Em caso de perda do dispositivo ou saída da organização, pode-se limpar remotamente os dados do xD Drive dos dispositivos associados ao {userid}. Só funciona se estiverem conectados à Internet.",
    ...
    "This app is not marked as compatible with your xD Drive version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Este aplicativo não está marcado como compatível com sua versão do xD Drive. Se você continuar, ainda poderá instalar o aplicativo mas poderá não funcionar como esperado.",
    "Never" : "Nunca",
    ...
    "Check the security of your xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Verifique a segurança do seu xD Drive em <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">nossa verificação de segurança ↗</a>.",
    "Version" : "Versão",
    ...
    "Reasons to use xD Drive in your organization" : "Motivos para usar o xD Drive na sua empresa.",
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Desenvolvido pela {communityopen}comunidade xD Drive{linkclose}. O {githubopen}código-fonte{linkclose} é licenciado sob a {licenseopen}AGPL{linkclose}.",
    ...
    "This community release of xD Drive is unsupported and instant notifications are unavailable." : "Este lançamento comunitário do xD Drive não é compatível e as notificações instantâneas não estão disponíveis. ",
    ...
    "Could not determine if TLS version of cURL is outdated or not because an error happened during the HTTPS request against https://drive.xd-twin.io Please check the nextcloud log file for more details." : "Não foi possível determinar se a versão TLS de cURL está desatualizada ou não porque ocorreu um erro durante a solicitação HTTPS em https://drive.xd-twin.io Verifique o arquivo de log do nextcloud para obter mais detalhes.",
