OC.L10N.register(
    ...
    "OPcache is configured to remove code comments. With OPcache enabled, <code>opcache.save_comments=1</code> must be set for xD Drive to function." : "Модуль OPcache настроен таким образом, что производит удаление комментариев кода. При использовании OPcache в  xD Drive необходимо использовать параметр <code>opcache.save_comments=1</code>.",
    "xD Drive is not allowed to use the OPcache API. With OPcache enabled, it is highly recommended to include all xD Drive directories with <code>opcache.restrict_api</code> or unset this setting to disable OPcache API restrictions, to prevent errors during xD Drive core or app upgrades." : "xD Drive не разрешено использовать API OPcache. При включенном OPcache настоятельно рекомендуется включить все каталоги xD Drive в <code>opcache.restrict_api</code> или снять этот параметр для отключения ограничений API OPcache, чтобы избежать ошибок при обновлении ядра xD Drive или приложений.",
    "xD Drive is not allowed to use the OPcache API. It is highly recommended to include all xD Drive directories with <code>opcache.restrict_api</code> or unset this setting to disable OPcache API restrictions, to prevent errors during xD Drive core or app upgrades." : "xD Drive не разрешено использовать API OPcache. Настоятельно рекомендуется включить все каталоги xD Drive в <code>opcache.restrict_api</code> или снять этот параметр для отключения ограничений API OPcache, чтобы предотвратить ошибки при обновлении ядра xD Drive или приложений.",
    ...
    "There are some user imported SSL certificates present, that are not used anymore with xD Drive 21. They can be imported on the command line via \"occ security:certificates:import\" command. Their paths inside the data directory are shown below." : "Обнаружены пользовательские сертификаты SSL, которые более не используются с xD Drive 21. Их можно импортировать командой \"occ security:certificates:import\". Их расположение в папке с данными показаны ниже.",
    ...
    "MariaDB version \"%s\" is used. xD Drive 21 and higher do not support this version and require MariaDB 10.2 or higher." : "Используется MariaDB версии %s. В xD Drive версии 21 эта версия не поддерживается, а для работы требуется MariaDB версии 10.2 или старше.",
    "MySQL version \"%s\" is used. xD Drive 21 and higher do not support this version and require MySQL 8.0 or MariaDB 10.2 or higher." : "Используется mySQL версии %s.  В xD Drive версии 21 эта версия не поддерживается, а для работы требуется MySQL версии 8 или MariaDB 10.2 или старше.",
    "PostgreSQL version \"%s\" is used. xD Drive 21 and higher do not support this version and require PostgreSQL 9.6 or higher." : "Используется PostgreSQL версии %s.  В xD Drive версии 21 эта версия не поддерживается, а для работы требуется PostgreSQL версии 9.6 или старше.",
    ...
    "xD Drive settings" : "Параметры xD Drive",
    ...
    "Remove" : "Удалить",
    "Disable" : "Отключить",
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "Для этого приложения не указана минимальная поддерживаемая версия xD Drive,  в будущем это будет считаться ошибкой.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Для этого приложения не указана максимальная поддерживаемая версия xD Drive, в будущем это будет считаться ошибкой.",
    ...
    "This app is supported via your current xD Drive subscription." : "Это приложение поддерживается через вашу текущую подписку xD Drive.",
    ...
    "No apps found for your version" : "Приложений, совместимых с установленной версией xD Drive, не найдено",
    ...
    "For the server to work properly, it's important to configure background jobs correctly. Cron is the recommended setting. Please see the documentation for more information." : "Для правильной работы сервера xD Drive важно правильно настроить выполнение задач в фоновом режиме. Рекомендуемым вариантом запуска фоновых задач является использование планировщика Cron. Обратитесь к документации для получения дополнительной информации.",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the xD Drive data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "Это действие позволяет удалить все данные xD Drive с устройств {userid}, например, в случае утери или при завершении работы сотрудника в компании. Удаление будет выполнено только если устройства подключены к интернету.",
    ...
    "This app is not marked as compatible with your xD Drive version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Это приложение не отмечено как совместимое с вашей версией xD Drive. Если вы продолжите, вы сможете установить это приложение, однако оно может работать не так, как ожидается.",
    "Never" : "Никогда",
    ...
    "Check the security of your xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Проверить безопасность xD Drive <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">нашим сканером ↗</a>.",
    "Version" : "Версия",
    ...
    "Reasons to use xD Drive in your organization" : "Причины использовать xD Drive в организации",
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Разработано {communityopen}сообществом xD Drive{linkclose}, {githubopen}исходный код{linkclose} лицензируется в соответствии с {licenseopen}AGPL{linkclose}.",
    ...
    "This community release of xD Drive is unsupported and instant notifications are unavailable." : "Это неподдерживаемая сборка сообщества xD Drive, в которой отключены моментальные уведомления.",
    ...
    "If you use third party applications to connect to xD Drive, please make sure to create and configure an app password for each before enabling second factor authentication." : "Если вы используете сторонние приложения для подключения к xD Drive, убедитесь что для них созданы и настроены пароли приложений, перед тем как активировать двухфакторную авторизацию.",
