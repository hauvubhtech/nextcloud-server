OC.L10N.register(
    ...
    "xD Drive settings" : "Stummoù xD Drive",
    "None" : "Hini ebet",
    ...
    "Remove" : "Lemel",
    "Disable" : "Disaotreañ",
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "N'en deus ket ar meziant ur stumm izelañ evit xD Drive. Ur fazi a vo en dazont.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Ar meziant n'en deus ket ur stumm huela eus xD Drive merked. Ur fazi vo en dazont.",
    ...
    "This app is supported via your current xD Drive subscription." : "Ar meziant-mañ a vez douget dre ho kommanant xD Drive.",
    "Supported" : "Douget",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the xD Drive data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "Ma peus kollet o ardivink pe kuitaet ar strollad, posupl e vefe lemet a pell roadennoù xD Drive eus tout o ardivinkoù liamet gant {userid}. Ne gerzh nemet ma eo kenstaget an ardivinkoù gant internet.",
    ...
    "This app is not marked as compatible with your xD Drive version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "N'eo ket ar meziant keverlec'h gant stumm xD Drive. Ma kendalc'hit e o posupl deoc'h staliañ ar meziant. Taolit evez, ne labouro ket ar meziant evel ma zlefe.",
    "Never" : "James",
    ...
    "Check the security of your xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Gwiriit surentez ho Nextcoud war <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">hon skan surentez ↗</a>.",
    "Version" : "Stumm",
    ...
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Digelet gant {communityopen}kummuniezh NExtcloud{linkclose}, ar {githubopen}c'hod orin{linkclose} a zo dindan aotre {licenseopen}AGPL{linkclose}.",
