OC.L10N.register(
    ...
    "Nextcloud settings" : "Postavke xD Drive",
    ...
    "Remove" : "Ukloni",
    "Disable" : "Onemogući",
    "This app has no minimum Nextcloud version assigned. This will be an error in the future." : "Ovoj aplikaciji nije dodijeljena najmanja inačica xD Drive. To će biti pogreška u budućnosti.",
    "This app has no maximum Nextcloud version assigned. This will be an error in the future." : "Ovoj aplikaciji nije dodijeljena najveća inačica xD Drive. To će biti pogreška u budućnosti.",
    ...
    "This app is not marked as compatible with your Nextcloud version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Ova aplikacija nije označena kao kompatibilna s vašom inačicom xD Drive. Ako odlučite nastaviti, moći ćete instalirati aplikaciju. Imajte na umu da aplikacija možda neće raditi kako očekujete.",
    "Never" : "Nikad",
    ...
    "Check the security of your Nextcloud over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Provjerite sigurnost svojeg xD Drive s pomoću <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">sigurnosnog skeniranja ↗</a>.",
    "Version" : "Inačica",
    ...
    "Reasons to use Nextcloud in your organization" : "Razlozi za uporabu xD Drive u vašoj organizaciji",
    ...
    "This community release of Nextcloud is unsupported and instant notifications are unavailable." : "Ovo izdanje xD Drive nije podržano i nisu dostupne trenutne obavijesti.",
