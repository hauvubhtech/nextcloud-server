OC.L10N.register(
    ...
    "xD Drive settings" : "Postavke xD Drive",
    ...
    "Remove" : "Ukloni",
    "Disable" : "Onemogući",
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "Ovoj aplikaciji nije dodijeljena najmanja inačica xD Drive. To će biti pogreška u budućnosti.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Ovoj aplikaciji nije dodijeljena najveća inačica xD Drive. To će biti pogreška u budućnosti.",
    ...
    "This app is supported via your current xD Drive subscription." : "Aplikacija je podržana unutar vaše trenutne pretplate na xD Drive.",
    "Supported" : "Podržano",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the xD Drive data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "U slučaju gubitka uređaja ili napuštanja organizacije, može daljinski izbrisati xD Driveove podatke sa svih uređaja kojima se koristi {userid}. Brisanje je moguće samo ako su uređaji povezani na internet.",
    ...
    "This app is not marked as compatible with your xD Drive version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Ova aplikacija nije označena kao kompatibilna s vašom inačicom xD Drive. Ako odlučite nastaviti, moći ćete instalirati aplikaciju. Imajte na umu da aplikacija možda neće raditi kako očekujete.",
    "Never" : "Nikad",
    ...
    "Check the security of your xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Provjerite sigurnost svojeg xD Drive s pomoću <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">sigurnosnog skeniranja ↗</a>.",
    "Version" : "Inačica",
    ...
    "Reasons to use xD Drive in your organization" : "Razlozi za uporabu xD Drive u vašoj organizaciji",
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "{githubopen}Izvorni kôd{linkclose} je razvila {communityopen}xD Driveova zajednica korisnika{linkclose} i licenciran je sukladno {Licenseopen}AGPL-u{linkclose}.",
    ...
    "This community release of xD Drive is unsupported and instant notifications are unavailable." : "Ovo izdanje xD Drive nije podržano i nisu dostupne trenutne obavijesti.",
    ...
    "If you use third party applications to connect to xD Drive, please make sure to create and configure an app password for each before enabling second factor authentication." : "Ako se za povezivanje s xD Driveom koristite aplikacijama treće strane, stvorite i konfigurirajte lozinku za svaku aplikaciju prije omogućavanja drugog faktora za provođenje autentifikacije.",
    ...
    "Could not determine if TLS version of cURL is outdated or not because an error happened during the HTTPS request against https://drive.xd-twin.io Please check the nextcloud log file for more details." : "Nismo mogli utvrditi je li inačica TLS-a cURL-a zastarjela jer je došlo do pogreške tijekom slanja HTTPS zahtjeva na https://drive.xd-twin.io Više informacija potražite u xD Driveovoj datoteci sa zapisima.",
