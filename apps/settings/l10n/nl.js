OC.L10N.register(
    ...
    "OPcache is configured to remove code comments. With OPcache enabled, <code>opcache.save_comments=1</code> must be set for xD Drive to function." : "OPcache is geconfigureerd om codeopmerkingen te verwijderen. Als OPcache is ingeschakeld, moet <code>opcache.save_comments=1</code> worden ingesteld om xD Drive te laten functioneren.",
    "xD Drive is not allowed to use the OPcache API. With OPcache enabled, it is highly recommended to include all xD Drive directories with <code>opcache.restrict_api</code> or unset this setting to disable OPcache API restrictions, to prevent errors during xD Drive core or app upgrades." : "xD Drive mag de OPcache API niet gebruiken. Met OPcache ingeschakeld, wordt het ten zeerste aanbevolen om alle xD Drive-mappen op te nemen met <code>opcache.restrict_api</code> of deze instelling uit te schakelen om OPcache API-beperkingen uit te schakelen, om fouten tijdens xD Drive-kern- of app-upgrades te voorkomen.",
    "xD Drive is not allowed to use the OPcache API. It is highly recommended to include all xD Drive directories with <code>opcache.restrict_api</code> or unset this setting to disable OPcache API restrictions, to prevent errors during xD Drive core or app upgrades." : "xD Drive mag de OPcache API niet gebruiken. Het wordt ten zeerste aanbevolen om alle xD Drive-mappen op te nemen met <code>opcache.restrict_api</code> of deze instelling uit te schakelen om OPcache API-beperkingen uit te schakelen, om fouten tijdens xD Drive-kern- of app-upgrades te voorkomen.",
    ...
    "There are some user imported SSL certificates present, that are not used anymore with xD Drive 21. They can be imported on the command line via \"occ security:certificates:import\" command. Their paths inside the data directory are shown below." : "Er zijn enkele door gebruikers geïmporteerde SSL-certificaten aanwezig, die niet meer worden gebruikt met xD Drive 21. Ze kunnen op de opdrachtregel worden geïmporteerd via het commando \"occ security:certificates:import\". De paden binnen de gegevensdirectory worden hieronder weergegeven.",
    ...
    "xD Drive settings" : "xD Drive instellingen",
    ...
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "Deze app heeft geen minimum xD Drive versie toegewezen gekregen. In de toekomst wordt dit wordt een fout.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Deze app heeft geen maximum xD Drive versie toegewezen gekregen. In de toekomst wordt dit wordt een fout.",
    ...
    "This app is supported via your current xD Drive subscription." : "Deze app wordt ondersteund via je huidige xD Drive abonnement.",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the xD Drive data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "In het geval van een verloren apparaat of het verlaten van de organisatie, kan dit op afstand de xD Drive-gegevens wissen van alle apparaten die zijn gekoppeld aan {userid}. Werkt alleen als de apparaten zijn verbonden met het internet.",
    ...
    "This app is not marked as compatible with your xD Drive version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Deze is niet aangeduid als compatibel met jouw versie van xD Drive. Als je verdergaat, zal je de app kunnen installeren. Let op dat de app misschien niet werkt zoals verwacht.",
    "Never" : "Nooit",
    ...
    "Check the security of your xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Controleer de beveiliging van je xD Drive via <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">onze securityscan ↗</a>.",
    "Version" : "Versie",
    ...
    "Reasons to use xD Drive in your organization" : "Redenen om xD Drive te gebruiken in jouw organisatie",
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Ontwikkeld door de {communityopen}xD Drive community{linkclose}, de {githubopen}broncode{linkclose} is gelicenseerd onder de {licenseopen}AGPL{linkclose}.",
    ...
    "This community release of xD Drive is unsupported and instant notifications are unavailable." : "Deze community release van xD Drive wordt niet ondersteund en instant meldingen zijn niet beschikbaar",
    ...
    "Could not determine if TLS version of cURL is outdated or not because an error happened during the HTTPS request against https://drive.xd-twin.io Please check the nextcloud log file for more details." : "Kan niet bepalen of de TLS-versie van cURL verouderd is of niet, omdat er een fout is opgetreden tijdens het HTTPS-verzoek voor https://drive.xd-twin.io Controleer het logbestand van xD Drive voor meer details.",
