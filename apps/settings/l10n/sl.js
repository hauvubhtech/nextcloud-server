OC.L10N.register(
    ...
    "xD Drive settings" : "Nastavitve xD Drive",
    ...
    "Remove" : "Odstrani",
    "Disable" : "Onemogoči",
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "Program nima določene omejitve različice okolja xD Drive. V prihodnosti se bo manjkajoči podatek pokazal kot napaka.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Program nima določene omejitve različice okolja Nextcoud. V prihodnosti se bo manjkajoči podatek pokazal kot napaka.",
    ...
    "This app is supported via your current xD Drive subscription." : "Program je podprt prek trenutne naročnine xD Drive",
    "Supported" : "Podprto",
    ...
    "This app is not marked as compatible with your xD Drive version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Ta program ni označen kot skladen z nameščeno različico oblaka xD Drive. Če nameravate nadaljevati, boste program lahko namestili, vendar ta morda ne bo deloval po pričakovanjih, ali pa bo vplival na stabilnost sistema.",
    "Never" : "Nikoli",
    ...
    "Check the security of your xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Preverite varnost storitev xD Drive s <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">preverjalnikom ↗</a>.",
    "Version" : "Različica",
    ...
    "Reasons to use xD Drive in your organization" : "Razlogi za uporabo oblaka xD Drive v vaši organizaciji",
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Okolje razvija {communityopen}skupnost xD Drive{linkclose}, {githubopen}izvorna koda{linkclose} pa je objavljena pod pogoji dovoljenja {licenseopen}AGPL{linkclose}.",
    ...
    "If you use third party applications to connect to xD Drive, please make sure to create and configure an app password for each before enabling second factor authentication." : "Če uporabljate za povezavo z oblakom xD Drive programe tretjih oseb, najprej ustvarite in nastavite gesla za vsak program, preden omogočite dvostopenjsko overitev.",
