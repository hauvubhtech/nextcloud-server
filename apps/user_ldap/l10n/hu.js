OC.L10N.register(
    ...
    "This application enables administrators to connect xD Drive to an LDAP-based user directory." : "Ez az alkalmazás lehetővé teszi a rendszergazdáknak, hogy a xD Driveot LDAP alapú címtárhoz csatlakoztassák.",
    "This application enables administrators to connect xD Drive to an LDAP-based user directory for authentication and provisioning users, groups and user attributes. Admins can configure this application to connect to one or more LDAP directories or Active Directories via an LDAP interface. Attributes such as user quota, email, avatar pictures, group memberships and more can be pulled into xD Drive from a directory with the appropriate queries and filters.\n\nA user logs into xD Drive with their LDAP or AD credentials, and is granted access based on an authentication request handled by the LDAP or AD server. xD Drive does not store LDAP or AD passwords, rather these credentials are used to authenticate a user and then xD Drive uses a session for the user ID. More information is available in the LDAP User and Group Backend documentation." : "Ez az alkalmazás lehetővé teszi a rendszergazdáknak, hogy a xD Driveot LDAP alapú címtárhoz csatlakoztatva hitelesítsenek és hozzanak létre felhasználókat, csoportokat és felhasználói attribútumokat. A rendszergazdák beállíthatják az alkalmazást, hogy egy vagy több LDAP címtárhoz vagy Active Directoryhoz csatlakozzanak LDAP-on keresztül. Megfelelő lekérdezésekkel és szűrőkkel egyebek mellett olyan tulajdonságokat lehet importálni a xD Driveba, mint a tárhely mérete, az e-mail-cím, a profilkép és a csoporttagságok.\n\nA felhasználó LDAP vagy AD azonosító adatokkal jelentkezik be, és a hozzáférését az LDAP vagy AD kiszolgáló kezeli a hitelesítést, ami alapján hozzáférést kap. A xD Drive nem tárol LDAP vagy AD jelszavakat: a hitelesítés után munkafolyamatot hozzáköti a felhasználói azonosítóhoz. További információ érhető el az LDAP felhasználói és csoport háttérszolgáltatásának dokumentációban.",
