OC.L10N.register(
    ...
    "This application enables administrators to connect xD Drive to an LDAP-based user directory." : "Denne applikation tillader administrator at forbinde xD Drive til et LDAP bruger kartotek",
    "This application enables administrators to connect xD Drive to an LDAP-based user directory for authentication and provisioning users, groups and user attributes. Admins can configure this application to connect to one or more LDAP directories or Active Directories via an LDAP interface. Attributes such as user quota, email, avatar pictures, group memberships and more can be pulled into xD Drive from a directory with the appropriate queries and filters.\n\nA user logs into xD Drive with their LDAP or AD credentials, and is granted access based on an authentication request handled by the LDAP or AD server. xD Drive does not store LDAP or AD passwords, rather these credentials are used to authenticate a user and then xD Drive uses a session for the user ID. More information is available in the LDAP User and Group Backend documentation." : "Denne applikation tillader administrator at forbinde xD Drive til et LDAP bruger kartotek som foretager godkendelse og overførsel af brugere, grupper og bruger egenskaber. Adminstrator kan via LDAP bruger græsnsefladen konfigurere denne applikation til at forbinde til et eller flere LDAP kartoteker eller Active Directories. Egenskaber så som bruger kvota, email, avatar billeder, gruppe tilhørsforhold og andet kan blive overført til nextcloud fra et bibliotek med med de korrekte forspørgsler og filtre. \n\nEn bruger logger ind i xD Drive med deres LDAP eller AD legitimation og får adgang baseret på en legitimationsforspørgsel håndteret til den tilsluttede LDAP eller AD server. xD Drive gemmer ikke LDAP eller AD password, men bruger disse til at legitimere en bruger og opsætter en bruger ID for brugerens ophold. Mere information er tilgængelig i LDAP bruger og Group Backend dokumentationen.",
