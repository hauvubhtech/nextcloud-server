OC.L10N.register(
    ...
    "Share with me through my #xD-Drive Federated Cloud ID, see %s" : "可透過我的 #xD-Drive 聯盟雲端 ID 與我分享，請看 %s",
    "Share with me through my #xD-Drive Federated Cloud ID" : "可透過我的 #xD-Drive 聯盟雲端 ID 與我分享",
    "Sharing" : "分享 ",
    ...
    "You can share with anyone who uses a xD Drive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "您可以與使用 xD Drive 伺服器或其他 Open Cloud Mesh（OCM）兼容伺服器和服務的任何人分享！只需將他們的聯盟式雲端 ID 放在分享對話框中。聯盟式雲端 ID 的格式為 person@cloud.example.com ",
    ...
    "Share with me via xD Drive" : "透過 xD Drive 與我分享",
    "HTML Code:" : "HTML 代碼：",
    "Share with me through my #xD-Drive Federated Cloud ID, see {url}" : "可透過我的 #xD-Drive 聯盟雲端 ID 與我分享，請見 {url}",
