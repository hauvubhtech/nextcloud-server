OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (xD Drive <= 9)." : "A föderált megosztás nem hozható létre, úgy tűnik, hogy a föderálandó kiszolgáló túl régi. (xD Drive <= 9).",
    ...
    "Share with me through my #xD-Drive Federated Cloud ID, see %s" : "Ossza meg velem a #xD-Drive föderált felhőazonosítóm segítségével, lásd %s",
    "Share with me through my #xD-Drive Federated Cloud ID" : "Ossza meg velem a #xD-Drive föderált felhőazonosítóm segítségével ",
    "Sharing" : "Megosztás",
    ...
    "You can share with anyone who uses a xD Drive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "Bármelyik xD Drive-kiszolgálót vagy egyéb Open Cloud Mesh-kompatibilis (OCM) kiszolgálót és szolgáltatást használó felhasználóval megoszthatja adatait. Csak tegye a föderált felhőazonosítóját a megosztási párbeszédablakba. Hasonlóan néz ki: person@cloud.example.com",
