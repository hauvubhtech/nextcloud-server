OC.L10N.register(
    ...
    "Share with me through my #xD-Drive Federated Cloud ID, see %s" : "Compartiu amb mi a través de la meva ID del núvol federat #xD-Drive, vegeu%s",
    "Share with me through my #xD-Drive Federated Cloud ID" : "Compartiu amb mi a través de la meva ID del núvol federat #xD-Drive",
    "Sharing" : "Comparteix",
    ...
    "HTML Code:" : "Codi HTML:",
    "Share with me through my #xD-Drive Federated Cloud ID, see {url}" : "Comparteix amb mi a través del meu ID del núvol federat #xD-Drive, consultar {url}",
