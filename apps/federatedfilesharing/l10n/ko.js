OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (xD Drive <= 9)." : "연합 공유를 설정할 수 없습니다. 연합하려고 하는 서버가 너무 오래되었습니다(xD Drive 9 이하).",
    ...
    "Share with me through my #xD-Drive Federated Cloud ID, see %s" : "내 #xD-Drive 연합 클라우드 ID를 통해서 공유됨, 더 알아보기: %s",
    "Share with me through my #xD-Drive Federated Cloud ID" : "내 #xD-Drive 연합 클라우드 ID를 통해서 공유됨",
    "Sharing" : "공유",
    ...
    "You can share with anyone who uses a xD Drive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "xD Drive 서버나 다른 Open Cloud Mesh(OCM) 호환 서버 및 서비스 사용자와 공유할 수 있습니다! 공유 대화 상자에 연합 클라우드 ID를 입력하십시오. person@cloud.example.com 형식입니다",
