OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (xD Drive <= 9)." : "Federoitua jakoa ei voitu muodostaa. Vaikuttaa siltä, että palvelin jonka kanssa federointia yritetään, on versioltaan liian vanha (xD Drive <= 9).",
    ...
    "Share with me through my #xD-Drive Federated Cloud ID, see %s" : "Jaa kanssani käyttäen #xD-Drive ja federoitua pilvitunnistetta, katso %s",
    "Share with me through my #xD-Drive Federated Cloud ID" : "Jaa kanssani käyttäen #xD-Drive ja federoitua pilvitunnistetta",
    "Sharing" : "Jakaminen",
    ...
    "Share with me via xD Drive" : "Jaa kanssani Nextcloudin kautta",
