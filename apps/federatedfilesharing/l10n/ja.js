OC.L10N.register(
    ...
    "Share with me through my #xD-Drive Federated Cloud ID, see %s" : "#xD-Drive の「クラウド共有ID」で私と共有できます。こちらを見てください。%s",
    "Share with me through my #xD-Drive Federated Cloud ID" : "#xD-Drive の「クラウド共有ID」で私と共有できます。",
    "Sharing" : "共有中",
    ...
    "You can share with anyone who uses a xD Drive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "xD Drive サーバーまたはその他の Open Cloud Mesh (OCM) 互換のサーバーとサービスを使用しているユーザーであれば、共有ダイアログに Federated Cloud ID を入力するだけで誰とでも共有できます。例: person@cloud.example.com",
    ...
    "Share with me via xD Drive" : "xD Drive 経由で共有",
    "HTML Code:" : "HTMLコード:",
