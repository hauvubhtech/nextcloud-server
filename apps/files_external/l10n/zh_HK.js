OC.L10N.register(
    ...
    "Are you sure you want to disconnect this external storage? It will make the storage unavailable in xD Drive and will lead to a deletion of these files and folders on any sync client that is currently connected but will not delete any files and folders on the external storage itself." : "您確定要斷開此外部存儲嗎？ 這將使該外部存儲在 xD Drive 中不可用，將導致在當前連接的任何同步客戶端上刪除這些檔案件和資料夾，但不會刪除外部存儲本身上的任何檔案和資料夾。",
    "Delete storage?" : "刪除空間",
    "Saved" : "已儲存",
    "Saving …" : "儲存中 ...",
    "Save" : "儲存",
